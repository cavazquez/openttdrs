...
| IA rivales propias | TransCargo y RoadHaul construyen rutas | 🟡 | [TransCargo #596](https://github.com/cavazquez/openttdrs/issues/596) implementado: carbón físico, órdenes y saldo aislado de la compañía humana ([evidencia](docs/parity/transcargo-v1.md)); falta CI remota vigente. Sigue la primera entrega de [RoadHaul #597](https://github.com/cavazquez/openttdrs/issues/597); no NoAI/Squirrel |
