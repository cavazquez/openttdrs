...
**Prioridad de implementación:** #569–#571 (CI), después #572–#577
...
Backlog vivo al 2026-09-18: nueve [issues del repo](https://github.com/cavazquez/openttdrs/issues)
(#569–#577), con orden y aceptación en el [plan vigente](docs/parity/continuous-work-plan.md).
El ajuste de formato #568 ya fue entregado.
