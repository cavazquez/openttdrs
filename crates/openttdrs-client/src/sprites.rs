...
pub use rail::{
    ...
    RailDepotLayerGfx, SignalSpriteDraw, WIRE_SPRITE_BASE, WIRE_SPRITE_LAST,
    catenary_depot_wire_draw, catenary_pylon_sprite_ids, catenary_pylon_world_z_delta,
    catenary_reference_sprite_id, catenary_sprite_gfx, catenary_tile_location_group,
    catenary_tileh_selector, catenary_tunnel_exterior_pcp, catenary_tunnel_wire_sprite,
    catenary_wire_sprite_ids, catenary_wire_world_z_delta, collect_catenary_bridge_draws,
    collect_catenary_pylons_from_map, collect_catenary_pylons_from_map_with_pcp_override,
