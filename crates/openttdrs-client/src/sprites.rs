...
pub use rail::{
    ...
    level_crossing_rail_sprite_id, rail_depot_build_layers, rail_flat_draws_separate_clear_ground,
    rail_ghost_overlay_offset, rail_signal_present_mask, rail_signal_state_mask,
    rail_signal_subtile_offset, rail_sprite_ids_for_preload, rail_tile_is_signals, signal_draw_pos,
