...
pub use road::{
    ...
    ROADSIDE_TREE_META, ROADSIDE_TREES, RoadDepotLayerGfx, SPR_EXCAVATION_X, SPR_EXCAVATION_Y,
    SPR_ROADSIDE_TREE, oneway_road_sprite_id, road_catenary_sprite_ids, road_depot_build_layers,
    road_depot_entrance_road_bits, road_depot_seq_gfx, road_ground_sprite_id,
    road_streetlight_sprite_id, road_tile_roadside, road_works_sprite_id, roadside_is_paved,
};
...
pub use rail::{
    ...
    RailDepotLayerGfx, SignalSpriteDraw, TRAMWAY_SPRITE_BASE, TRAMWAY_SPRITE_LAST,
    WIRE_SPRITE_BASE, WIRE_SPRITE_LAST, catenary_depot_wire_draw, catenary_pylon_sprite_ids,
    catenary_pylon_world_z_delta, catenary_reference_sprite_id, catenary_sprite_atlas_key,
    catenary_sprite_gfx, catenary_tile_location_group, catenary_tileh_selector,
    catenary_tunnel_exterior_pcp, catenary_tunnel_wire_sprite, catenary_wire_sprite_ids,
    catenary_wire_world_z_delta, collect_catenary_bridge_draws, collect_catenary_pylons_from_map,
    collect_catenary_pylons_from_map_with_pcp_override, collect_catenary_ramp_draws_from_map,
    collect_catenary_sprites, collect_catenary_sprites_from_map,
    collect_catenary_wire_draws_from_map, collect_rail_ghost_sprites,
    ...
    level_crossing_rail_sprite_id, level_crossing_rail_sprite_id_for_type,
    level_crossing_sprite_atlas_key, rail_depot_build_layers, rail_depot_custom_sprite_index,
    rail_depot_seq_gfx, rail_depot_visual_type_index, rail_ghost_overlay_offset,
    rail_pbs_reservation_offset, rail_pbs_sprite_ids_for_preload, rail_signal_present_mask,
    ...
    rail_tile_is_signals, remap_rail_sprite_id, signal_draw_pos,
    signal_safe_slope_position_for_side, signal_screen_anchor_for_side, signal_screen_position,
...
pub use station::{
    ...
    rail_waypoint_parent_slot, rail_waypoint_sprite_center, road_stop_build_layers,
...
pub use transparency::{
    ...
    set_transparency_preferences, sprite_color, text_effects_hidden, with_to_alpha,
};
