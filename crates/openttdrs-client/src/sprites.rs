...
pub use rail::{
    ...
    catenary_pylon_world_z_delta, catenary_reference_sprite_id, catenary_sprite_gfx,
    catenary_tile_location_group, catenary_tileh_selector, catenary_tunnel_exterior_pcp,
    catenary_tunnel_wire_sprite, catenary_wire_sprite_ids, catenary_wire_world_z_delta,
    collect_catenary_bridge_draws, collect_catenary_pylons_from_map,
    ...
    level_crossing_rail_sprite_id_for_type, level_crossing_sprite_atlas_key,
    rail_depot_build_layers, rail_depot_seq_gfx, rail_depot_visual_type_index,
    rail_ghost_overlay_offset, rail_pbs_reservation_offset, rail_pbs_sprite_ids_for_preload,
