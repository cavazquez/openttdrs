...
pub const HOUSE_DRAW_DATA: [HouseDrawSpec; 128] = [
    ...
    house_spec(1424, 64.0, 37.0, -31.0, -6.0, 1423, 65.0, 76.0, -32.0, -45.0),
    // 1-3: Office Block variants – s1=1424, s2=1425
    house_spec(1424, 64.0, 37.0, -31.0, -6.0, 1425, 65.0, 71.0, -31.0, -40.0),
    house_spec(1424, 64.0, 37.0, -31.0, -6.0, 1425, 65.0, 71.0, -31.0, -40.0),
    house_spec(1424, 64.0, 37.0, -31.0, -6.0, 1425, 65.0, 71.0, -31.0, -40.0),
    // 4-7: Large Office Block – s1=1429, s2=1428
    house_spec(1429, 64.0, 36.0, -31.0, -5.0, 1428, 66.0, 87.0, -32.0, -56.0),
    house_spec(1429, 64.0, 36.0, -31.0, -5.0, 1428, 66.0, 87.0, -32.0, -56.0),
    house_spec(1429, 64.0, 36.0, -31.0, -5.0, 1428, 66.0, 87.0, -32.0, -56.0),
    house_spec(1429, 64.0, 36.0, -31.0, -5.0, 1428, 66.0, 87.0, -32.0, -56.0),
    // 8-11: Small Block of Flats – s1=1433, s2=1432
    house_spec(1433, 64.0, 35.0, -31.0, -4.0, 1432, 35.0, 37.0, -18.0, -15.0),
    house_spec(1433, 64.0, 35.0, -31.0, -4.0, 1432, 35.0, 37.0, -18.0, -15.0),
    house_spec(1433, 64.0, 35.0, -31.0, -4.0, 1432, 35.0, 37.0, -18.0, -15.0),
    house_spec(1433, 64.0, 35.0, -31.0, -4.0, 1432, 35.0, 37.0, -18.0, -15.0),
    // 12-15: Church – s1=1437, s2=1436
    house_spec(1437, 64.0, 34.0, -31.0, -3.0, 1436, 38.0, 38.0, -19.0, -14.0),
    house_spec(1437, 64.0, 34.0, -31.0, -3.0, 1436, 38.0, 38.0, -19.0, -14.0),
    house_spec(1437, 64.0, 34.0, -31.0, -3.0, 1436, 38.0, 38.0, -19.0, -14.0),
    house_spec(1437, 64.0, 34.0, -31.0, -3.0, 1436, 38.0, 38.0, -19.0, -14.0),
    ...
    house_spec(1495, 64.0, 34.0, -31.0, -3.0, 1496, 26.0, 29.0, -14.0, -10.0),
    house_spec(1495, 64.0, 34.0, -31.0, -3.0, 1496, 26.0, 29.0, -14.0, -10.0),
    house_spec(1495, 64.0, 34.0, -31.0, -3.0, 1496, 26.0, 29.0, -14.0, -10.0),
    house_spec(1495, 64.0, 34.0, -31.0, -3.0, 1496, 26.0, 29.0, -14.0, -10.0),
    ...
    house_spec(1574, 64.0, 34.0, -31.0, -3.0, 1575, 32.0, 27.0, -17.0, -11.0),
    ...
    house_spec(1522, 64.0, 34.0, -31.0, -3.0, 1523, 40.0, 38.0, -19.0, -18.0),
    house_spec(1522, 64.0, 34.0, -31.0, -3.0, 1523, 40.0, 38.0, -19.0, -18.0),
    // 110-111: Casa con árboles – s1=1528, s2=1529
    house_spec(1528, 64.0, 35.0, -31.0, -4.0, 1529, 45.0, 46.0, -22.0, -20.0),
    house_spec(1528, 64.0, 35.0, -31.0, -4.0, 1529, 45.0, 46.0, -22.0, -20.0),
    // 112-113: Casa con torre – s1=1534, s2=1535
    house_spec(1534, 64.0, 31.0, -31.0, 0.0, 1535, 53.0, 102.0, -27.0, -75.0),
    house_spec(1534, 64.0, 31.0, -31.0, 0.0, 1535, 53.0, 102.0, -27.0, -75.0),
    ...
    house_spec(1536, 64.0, 38.0, -31.0, -7.0, 1537, 66.0, 71.0, -32.0, -40.0),
    house_spec(1536, 64.0, 38.0, -31.0, -7.0, 1537, 66.0, 71.0, -32.0, -40.0),
    // 118-119: Oficina moderna B – s1=1538, s2=1539
    house_spec(1538, 64.0, 36.0, -31.0, -5.0, 1539, 66.0, 87.0, -32.0, -56.0),
    house_spec(1538, 64.0, 36.0, -31.0, -5.0, 1539, 66.0, 87.0, -32.0, -56.0),
