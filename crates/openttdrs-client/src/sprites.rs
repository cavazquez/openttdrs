...
pub use rail::{
    ...
    SignalSpriteDraw, WIRE_SPRITE_BASE, WIRE_SPRITE_LAST, catenary_depot_wire_draw,
    catenary_pylon_sprite_ids, catenary_pylon_world_z_delta, catenary_reference_sprite_id,
    ...
    signal_world_position_for_side,
};
