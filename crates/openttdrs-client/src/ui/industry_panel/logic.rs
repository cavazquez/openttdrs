...
pub(crate) fn spec_label(spec: IndustrySpec) -> &'static str {
    match spec {
        ...
        IndustrySpec::DiamondMine => "Mina de diamantes",
        IndustrySpec::Forest => "Bosque",
        IndustrySpec::Farm => "Granja",
        IndustrySpec::FarmTropic => "Granja tropical",
        IndustrySpec::OilWells => "Pozos petroleros",
        IndustrySpec::OilRefinery => "Refinería",
        IndustrySpec::OilRig => "Plataforma petrolera",
        IndustrySpec::Factory => "Fábrica",
        IndustrySpec::FactoryTropic => "Fábrica tropical",
        IndustrySpec::Sawmill => "Aserradero",
        IndustrySpec::PaperMill => "Papelera",
        IndustrySpec::PrintingWorks => "Imprenta",
        IndustrySpec::FoodProcessingPlant => "Planta de alimentos",
        IndustrySpec::FruitPlantation => "Plantación de fruta",
        IndustrySpec::RubberPlantation => "Plantación de caucho",
        IndustrySpec::WaterSupply => "Suministro de agua",
        IndustrySpec::WaterTower => "Torre de agua",
        IndustrySpec::LumberMill => "Aserradero tropical",
        IndustrySpec::SteelMill => "Acería",
        IndustrySpec::Bank => "Banco",
        IndustrySpec::BankArcticTropic => "Banco (ártico/trópico)",
        ...
        IndustrySpec::ToyShop => "Tienda de juguetes",
