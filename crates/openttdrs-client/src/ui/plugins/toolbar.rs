...
use crate::ui::toolbar::{
    ...
    object_picker_on_closed, order_panel_on_closed, rail_station_picker_on_closed,
    rail_waypoint_picker_on_closed, road_stop_picker_on_closed, road_type_filter_keyboard,
    road_waypoint_picker_on_closed, rotate_station_with_right_click, setup_airport_picker,
    setup_bridge_picker, setup_build_menu, setup_buoy_picker, setup_depot_build_picker,
    setup_depot_panel, setup_dock_picker, setup_minimap, setup_object_picker, setup_order_panel,
    setup_rail_station_picker, setup_rail_waypoint_picker, setup_road_stop_picker,
    setup_road_waypoint_picker, setup_sign_picker, setup_signal_picker, setup_station_cargo_panel,
    setup_terraform_picker, setup_top_toolbar, setup_tree_picker, sign_picker_on_closed,
    signal_picker_on_closed, station_catalog_filter_keyboard, station_rename_editable_keyboard,
    station_rename_keyboard, station_view_on_closed, sync_action5_gui_toolbar_icons,
    sync_airport_picker, sync_airport_preview_image, sync_bridge_picker,
    sync_build_pointer_modifiers, sync_buoy_picker, sync_climate_industry_tools,
    sync_company_colour_swatch_visuals, sync_company_selector, sync_depot_build_picker,
    sync_depot_panel, sync_dock_picker, sync_editor_only_build_tools, sync_minimap,
    sync_object_catalog_entries, sync_object_picker, sync_object_preview_image, sync_order_panel,
    sync_orders_pick_cursor, sync_rail_station_picker, sync_rail_toolbar_icons,
    sync_rail_type_select_visuals, sync_rail_waypoint_picker, sync_road_driving_side_button_label,
    ...
    sync_road_type_entry_visibility, sync_road_type_popovers, sync_road_waypoint_picker,
    sync_sign_picker, sync_signal_picker, sync_station_cargo_panel, sync_station_catalog_entries,
    sync_station_spec_entry_previews, sync_terraform_picker, sync_toolbar_layout, sync_tree_picker,
