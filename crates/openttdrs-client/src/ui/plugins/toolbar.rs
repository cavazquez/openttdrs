...
use crate::ui::toolbar::{
    ...
    depot_build_picker_on_closed, depot_panel_on_closed, depot_rename_editable_keyboard,
    depot_rename_keyboard, dock_picker_on_closed, finish_depot_list_drag, finish_order_list_drag,
    handle_airport_picker_buttons, handle_bridge_picker_buttons, handle_cheats_menu_button,
    handle_company_colour_swatches, handle_company_selector_buttons,
    handle_depot_build_picker_buttons, handle_depot_panel_buttons, handle_depot_rename_buttons,
    ...
    sync_depot_build_picker, sync_depot_panel, sync_depot_panel_consist, sync_dock_picker,
    sync_editor_only_build_tools, sync_freight_trains_button_label, sync_minimap,
        ...
        app.init_resource::<UiToolState>()
            ...
            .add_systems(
                ...
                (
                    ...
                    handle_depot_rename_buttons,
                    depot_rename_keyboard,
                    depot_rename_editable_keyboard,
                )
                    .in_set(UpdateSet::Ui)
                    .run_if(in_state(ClientScreen::InGame)),
            )
