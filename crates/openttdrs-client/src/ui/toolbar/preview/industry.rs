...
pub(crate) fn industry_spec_for_action(action: BuildMenuAction) -> Option<IndustrySpec> {
    match action {
        ...
        BuildMenuAction::BuildFarmTropic => Some(IndustrySpec::FarmTropic),
        BuildMenuAction::BuildCopperOreMine => Some(IndustrySpec::CopperOreMine),
        BuildMenuAction::BuildFactoryTropic => Some(IndustrySpec::FactoryTropic),
        BuildMenuAction::BuildFruitPlantation => Some(IndustrySpec::FruitPlantation),
        BuildMenuAction::BuildRubberPlantation => Some(IndustrySpec::RubberPlantation),
        BuildMenuAction::BuildPaperMill => Some(IndustrySpec::PaperMill),
        BuildMenuAction::BuildFoodProcessingPlant => Some(IndustrySpec::FoodProcessingPlant),
        BuildMenuAction::BuildDiamondMine => Some(IndustrySpec::DiamondMine),
        BuildMenuAction::BuildWaterSupply => Some(IndustrySpec::WaterSupply),
        BuildMenuAction::BuildLumberMill => Some(IndustrySpec::LumberMill),
