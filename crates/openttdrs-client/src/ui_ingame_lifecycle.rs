...
pub(crate) fn leave_ingame(world: &mut World) {
    ...
    if let Some(mut newgrf_road_sprites) =
        world.get_resource_mut::<crate::render::NewGrfRoadSpriteCache>()
    {
        newgrf_road_sprites.clear();
    }
    if let Some(mut newgrf_station_sprites) =
        world.get_resource_mut::<crate::render::NewGrfStationSpriteCache>()
    {
    ...
    if let Some(mut newgrf_catenary_sprites) =
        world.get_resource_mut::<crate::render::NewGrfCatenarySpriteCache>()
    {
        newgrf_catenary_sprites.clear();
    }
    ...
    world.remove_resource::<crate::render::NewGrfCatenarySpriteCache>();
}
