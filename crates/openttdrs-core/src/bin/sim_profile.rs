...
fn print_timings(t: &TickPhaseTimings) {
    let rows = [
        ...
        ("  path_order_sync", t.path_order_sync_ns),
        ("  path_station_route", t.path_station_route_ns),
        ("  path_generic_route", t.path_generic_route_ns),
        ("vehicle_ops_pre_move", t.vehicle_ops_pre_move_ns),
        ("  vehicle_ops_only", t.vehicle_ops_only_ns),
        ("    autoreplace", t.vehicle_ops_autoreplace_ns),
        ("  pbs_pre_move", t.pbs_pre_move_ns),
        ("cargo_transfer", t.cargo_transfer_ns),
        ("  cargo_calendar_day", t.cargo_calendar_day_ns),
        ("  cargo_economy_day", t.cargo_economy_day_ns),
        ("  cargo_aging", t.cargo_aging_ns),
        ("  cargo_unload", t.cargo_unload_ns),
        ("  cargo_load", t.cargo_load_ns),
        ("movement", t.movement_ns),
        ("  vehicle_move", t.vehicle_move_ns),
        ("  train_collision", t.train_collision_ns),
        ("  crashed_vehicle", t.crashed_vehicle_ns),
        ("  pbs_post_move", t.pbs_post_move_ns),
