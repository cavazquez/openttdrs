//! Stub MCF legado (#49 MVP). El camino de juego usa [`crate::cargodist::parity`].
//!
...
use crate::cargodist::legacy::flow_stat::{DistributionType, StationFlows};
use crate::cargodist::legacy::link_graph::{LinkEdgeKey, LinkGraphStats};
...
mod tests {
    use super::*;
    use crate::cargodist::legacy::flow_stat::resolve_next_hop;
