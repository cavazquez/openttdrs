...
const PRICE_BASE_SPECS: [PriceBaseSpec; PRICE_TABLE_LEN] = {
    ...
    table[20] = spec(20, PriceCategory::Construction);
    table[21] = spec(250, PriceCategory::Construction);
    table[22] = spec(20, PriceCategory::Construction);
    ...
    table[44] = spec(4_800, PriceCategory::Running);
    table[45] = spec(9_600, PriceCategory::Running);
    table[46] = spec(1_600, PriceCategory::Running);
