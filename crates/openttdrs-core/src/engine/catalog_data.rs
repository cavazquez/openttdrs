...
use super::model::{
    DEFAULT_CARGO_AGE_PERIOD, DEFAULT_RELIABILITY_SPD_DEC, DEFAULT_SHIP_ACCELERATION, EngineDef,
    SHIP_RELIABILITY_SPD_DEC, VEHICLE_VISUAL_EFFECT_DEFAULT,
};
...
macro_rules! road {
    ...
    ($id:expr, $kind:expr, $name:expr, $speed:expr, $cf:expr, $rc:expr, $cap:expr, $cargo:expr, $hp:expr, $wt:expr, $year:expr, $life:expr, $spd_dec:expr) => {
        EngineDef {
            ...
            ship_acceleration: DEFAULT_SHIP_ACCELERATION,
