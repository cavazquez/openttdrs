...
pub use map::{
    ...
    advance_industry_tile_loop_events, airport_radar_frame, apply_desert_transition_from_visits,
    apply_seasonal_snow, bridge_foundation_for_axis, bridge_surface_slope_and_z,
    bubble_generator_spawns_from_visits, clear_tree, coord_from_linear_index, coord_to_dense_index,
    coord_to_linear_index, do_flood_tile, effective_rail_trackbits, effective_road_bits,
    flood_vehicles, foundation_draw_plan, get_flooding_behaviour, inclined_slope_direction,
