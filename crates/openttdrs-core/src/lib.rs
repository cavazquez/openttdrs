...
pub use newgrf_sprites::{
    ...
    build_action1_trains_payload, build_action2_trains_payload, build_action2_vehicle_payload,
    ...
    build_grf_v2_train_with_action2_chain, build_grf_v2_train_with_compressed_sprite,
    ...
    build_real_sprite_v1_uncompressed_payload, catenary_action5_local_slot, collect_action5_blocks,
    collect_feature_sprite_graphics, collect_roadtype_sprite_graphics,
    ...
    indices_to_rgba, merge_catenary_action5_block, merge_shore_action5_block,
};
pub use news::{
