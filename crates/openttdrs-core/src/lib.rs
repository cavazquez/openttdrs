...
pub use newgrf_sprites::{
    ...
    SPRITE_V2_ZOOM_PREFERENCE, TRAMWAY_ACTION5_SLOT_COUNT, TRAMWAY_DEPOT_NO_TRACK_ACTION5_SLOT,
    TRAMWAY_DEPOT_WITH_TRACK_ACTION5_SLOT, TWOCC_ACTION5_SLOT_COUNT, TWOCC_PALETTE_BASE,
    TrainSpriteAssign, TrainSpriteGraphics, TramwayDepotReplacement, action5_type_name,
    ...
    collect_train_sprite_graphics, disallowed_road_directions,
