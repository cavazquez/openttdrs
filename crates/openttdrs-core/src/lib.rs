...
pub use industry_spec::{
    INDUSTRY_CALLBACK_DECIDE_COLOUR_MASK, INDUSTRY_CALLBACK_LOCATION_MASK,
    INDUSTRY_CALLBACK_MONTHLY_PROD_CHANGE_MASK, INDUSTRY_CALLBACK_PROD_CHANGE_BUILD_MASK,
...
pub use newgrf_callback::{
    ...
    resolve_industry_refuse_cargo_callback, resolve_industry_tile_animation_callback,
