...
pub use newgrf_callback::{
    ...
    resolve_vehicle_refit_cost_callback, resolve_vehicle_sound_callback,
    resolve_vehicle_spawn_visual_effect_callback, resolve_vehicle_start_stop_callback,
    ...
    vehicle_visual_effect_spec, vehicle_weight_t,
