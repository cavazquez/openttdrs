...
pub use road_stop_spec::{
    ...
    ROADSTOP_FLAG_NO_CATENARY, ROADSTOP_FLAG_ROAD_ONLY, ROADSTOP_FLAG_TRAM_ONLY, ROADSTOP_TYPE_ALL,
    ROADSTOP_TYPE_BUS, ROADSTOP_TYPE_TRUCK, RSV_BAY_NE, RSV_BAY_NW, RSV_BAY_SE, RSV_BAY_SW,
    RSV_DRIVE_THROUGH_X, RSV_DRIVE_THROUGH_Y, RoadStopClassDef, RoadStopSpecDef,
