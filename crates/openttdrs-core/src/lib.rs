...
pub use map::{
    ...
    advance_industry_tile_randomisation_from_visits_with_catalog_and_world, airport_radar_frame,
...
pub use newgrf_callback::{
    ...
    apply_house_construction_callback_for_build, apply_industry_location_callback,
    ...
    apply_object_slope_callback_for_build, apply_station_availability_callback,
    ...
    callback_draws_default_foundation, effective_vehicle_max_speed_with_catalog,
    ...
    resolve_industry_tile_animation_callback_with_world, resolve_industry_tile_random_trigger,
...
pub use newgrf_sprites::{
    ...
    CBID_INDTILE_DRAW_FOUNDATIONS, CBID_INDTILE_SHAPE_CHECK, CBID_INDUSTRY_LOCATION,
