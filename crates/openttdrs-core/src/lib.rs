...
pub use newgrf_callback::{
    ...
    RoadStopCallbackWorld, Vehicle32DayCallback, VehicleAdvancedVisualEffect,
    VehicleAdvancedVisualEffectSpawn, VehicleColourMapping, VehicleRefitCostResult,
    VehicleSoundOverride, VehicleStartStopCallbackDiagnostic, VehicleStartStopCallbackOutcome,
    VehicleVisualEffectKind, VehicleVisualEffectSpec, action2_eval_ctx_from_station,
    ...
    apply_station_availability_callback_with_spec, apply_vehicle_start_stop_callback,
    callback_allows_8bit_boolean, callback_allows_location, callback_allows_placement,
    callback_draws_default_foundation, classify_vehicle_start_stop_callback,
    decode_vehicle_refit_cost_result, effective_vehicle_max_speed_with_catalog,
    engine_for_vehicle_catalog, industry_tile_autoslope_callback_allows,
    industry_tile_shape_callback_allows, resolve_callback_or_failed, resolve_cargo_profit_callback,
