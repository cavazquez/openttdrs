...
pub use engine::{
    ...
    RoadEngineFilter, RoadVehicleAccelerationModel, TrainAccelerationModel, accelerate_train_speed,
    ...
    get_curve_speed_limit, next_free_engine_id, progress_step_for_speed, road_default_air_drag,
    road_engine_air_drag, road_engine_tractive_effort, road_max_te_n, road_realistic_acceleration,
    road_rolling_friction, scale_train_air_drag, ship_speed_for_tile, tile_progress_length,
...
pub use newgrf_callback::{
    RoadStopCallbackWorld, VehicleSoundOverride, VehicleVisualEffectKind,
