...
pub use map::{
    ...
    SLOPE_NE, SLOPE_NW, SLOPE_SE, SLOPE_SW, TILE_PIXEL_HEIGHT, TREE_GROWTH_TICK_INTERVAL, Tile,
    TileCoord, TileKind, WaterClass, advance_industry_animated_tiles,
    advance_industry_construction, advance_industry_tile_animations,
    advance_industry_tile_loop_events, airport_radar_frame, apply_seasonal_snow, clear_tree,
    coord_from_linear_index, coord_to_dense_index, coord_to_linear_index, effective_road_bits,
    inclined_slope_direction, industry_animation_frame, industry_construction_counter,
    industry_construction_stage, industry_gfx, industry_instance_id, industry_random_bits,
    industry_random_triggers, industry_tile_anim_state, industry_tile_link, industry_tile_on_water,
    industry_tile_rng, industry_tiles_mergeable, industry_uses_water_ground,
    init_industry_tile_random, is_airport_tower_tile, is_canal_tile, is_industry_completed,
...
pub use newgrf_sprites::{
    ...
    bake_sprite_company_mask, build_action1_feature_payload, build_action1_trains_payload,
    ...
    collect_industry_tile_sprite_graphics, collect_roadtype_sprite_graphics,
    collect_station_sprite_graphics, collect_train_sprite_graphics, compress_grf_lz77_literals,
