...
pub use map::{
    ...
    effective_road_bits, inclined_slope_direction, industry_animation_frame,
    ...
    set_industry_gfx, set_industry_random_bits, set_industry_random_triggers, set_water_class_m1,
