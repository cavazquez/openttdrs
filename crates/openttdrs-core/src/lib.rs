...
pub use newgrf_callback::{
    IndustryProductionCallbackResult, IndustryTileCargoAcceptance, ObjectFundMoreText,
    ObjectSlopeCallbackDiagnostic, ObjectSlopeCallbackOutcome, RoadStopCallbackWorld,
    StationSlopeCallbackDiagnostic, StationSlopeCallbackOutcome, Vehicle32DayCallback,
    VehicleAdvancedVisualEffect, VehicleAdvancedVisualEffectSpawn, VehicleColourMapping,
    VehicleRefitCostResult, VehicleSoundOverride, VehicleStartStopCallbackDiagnostic,
    VehicleStartStopCallbackOutcome, VehicleVisualEffectKind, VehicleVisualEffectSpec,
    action2_eval_ctx_from_station, action2_eval_ctx_from_station_with_spec,
    ...
    apply_road_stop_availability_callback, apply_road_stop_availability_callback_with_context,
    apply_station_availability_callback, apply_station_availability_callback_at,
...
pub use newgrf_sprites::{
    ...
    CBID_CANALS_SPRITE_OFFSET, CBID_CARGO_PROFIT_CALC, CBID_CARGO_STATION_RATING_CALC,
    CBID_HOUSE_ALLOW_CONSTRUCTION, CBID_HOUSE_ANIMATION_NEXT_FRAME, CBID_HOUSE_ANIMATION_SPEED,
