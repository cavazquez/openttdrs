...
pub use industry_tile::{
    INDUSTRY_TILE_CALLBACK_DRAW_FOUNDATIONS_MASK, INVALID_INDUSTRY_TILE, IndustryTileGfxId,
    ...
    industry_tile_spec_def, next_free_industry_tile_gfx_id, resolve_industry_tile_draw_gfx,
};
pub use map::{
...
pub use newgrf_callback::{
    ...
    apply_industry_production_callback, apply_industry_tile_anim_callback,
    ...
    writeback_industry_persistent_registers, writeback_station_persistent_registers,
...
pub use newgrf_sprites::{
    ...
    CBID_INDTILE_ANIMATION_SPEED, CBID_INDTILE_ANIMATION_TRIGGER, CBID_INDTILE_DRAW_FOUNDATIONS,
...
pub use sav::{
    ...
    SavIndustryAcceptedCargo, SavIndustryProducedCargo, SavOpaqueChunk, SavPersistentStorage,
    SavStation, SavStationCargo, SavVehicle, SavVehicleKind, house_spec_is_size_1x1,
    house_spec_population, save as save_sav, save_to_bytes as save_sav_to_bytes,
};
