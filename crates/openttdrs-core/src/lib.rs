...
pub use map::{
    ...
    StationAnimationSound, TILE_PIXEL_HEIGHT, TREE_GROWTH_TICK_INTERVAL, Tile, TileCoord, TileKind,
    WaterClass, action2_eval_ctx_for_industry_tile_with_world,
...
pub use object_spec::{
    ...
    OBJECT_FLAG_ANIM_RANDOM_BITS, OBJECT_FLAG_ANIMATION, OBJECT_SIZE_1X1, ObjectSpecDef,
