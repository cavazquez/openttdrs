...
pub use airport::{
    ...
    is_airport_radar_station_gfx, newgrf_airport_footprint_with_layout,
...
pub use bridge_spec::{
    ...
    BridgeSpecDef, BridgeSpriteGraphicsTable, BridgeSpriteGraphicsTables, BridgeSpriteRef,
    BridgeSpriteTable, BridgeSpriteTables, BridgeType, bridge_above_axis_from_mapt,
    ...
    water_aqueduct_allows_adjacent_step, water_aqueduct_other_end,
};
pub use canal_spec::{
...
pub use cargo::{
    ...
    CARGO_CLASS_COVERED, CARGO_CLASS_EXPRESS, CARGO_CLASS_HAZARDOUS, CARGO_CLASS_LIQUID,
    CARGO_CLASS_MAIL, CARGO_CLASS_NON_POTABLE, CARGO_CLASS_NOT_POURABLE, CARGO_CLASS_OVERSIZED,
    CARGO_CLASS_PASSENGERS, CARGO_CLASS_PIECE_GOODS, CARGO_CLASS_POTABLE, CARGO_CLASS_POWDERIZED,
    CARGO_CLASS_REFRIGERATED, CARGO_CLASS_SPECIAL, CUSTOM_CARGO_COUNT, CUSTOM_CARGO_OFFSET,
    CargoStock, CargoType, MAX_CARGO_ID, NUM_ORIGINAL_CARGO, OrderSettings, TEMPERATE_CARGO_TYPES,
...
pub use economy::{
    ...
    airport_clear_cost, bridge_clear_cost, build_object_cost, build_object_cost_factored,
    buoy_build_cost, buoy_clear_cost, buy_land_cost, canal_build_cost, canal_clear_cost,
    cargo_current_payment, cargo_time_factor, check_bankruptcy, decrease_loan, dock_build_cost,
    dock_clear_cost, fields_clear_cost, grass_clear_cost, increase_loan, inflation_prices_factor,
    lock_build_cost, lock_clear_cost, manhattan_distance, monthly_loan_interest,
    object_clear_cost_factored, rail_build_cost_factored, rail_clear_cost, rail_station_clear_cost,
    rail_waypoint_clear_cost, road_build_cost_factored, road_clear_cost, road_clear_cost_factored,
    road_depot_clear_cost, road_stop_build_cost_factored, road_stop_clear_cost_factored,
    rocks_clear_cost, rough_clear_cost, terraform_cost_per_corner, ticks_to_transit_periods,
    train_depot_clear_cost, transported_goods_income, transported_goods_income_for_climate,
    transported_goods_income_with_spec, trees_clear_cost, tunnel_clear_cost,
    ...
    vehicle_sell_refund_with_catalog, water_clear_cost,
};
...
pub use engine::{
    ...
    ENGINE_WAGON_PASSENGER, EngineCatalogSort, EngineDef, EngineLifecycleState,
    NEWGRF_ENGINE_ID_BASE, REFERENCE_PROGRESS_STEP, ROAD_ACCEL_ORIGINAL, ROAD_AIR_DRAG_AREA,
    ROAD_TRACTIVE_EFFORT_DEFAULT, RoadEngineFilter, RoadVehicleAccelerationModel,
    TrainAccelerationModel, VEHICLE_VISUAL_EFFECT_DEFAULT, accelerate_train_speed,
    aircraft_is_helicopter, aircraft_is_helicopter_def, aircraft_is_jet, aircraft_is_jet_def,
    ...
    engine_in_catalog, engine_is_buildable_for_company, engine_lifecycle_state_in_year,
    engine_preview_group_for_in, engine_preview_group_in, engine_preview_root_id_in,
    engine_tractive_effort, engines_for_depot_kind, engines_for_depot_kind_in,
    engines_for_depot_purchase, engines_of_kind, get_advance_distance, get_advance_speed,
    get_curve_speed_limit, next_free_engine_id, poll_engine_previews, progress_step_for_speed,
    ...
    train_realistic_station_max_speed, train_smoke_kind, train_smoke_kind_for_engine,
...
pub use industry_scheduler_trace::{
    IndustrySchedulerTraceAction, IndustrySchedulerTraceBuildData, IndustrySchedulerTraceClock,
    IndustrySchedulerTraceIndustry, IndustrySchedulerTraceRandomState,
    IndustrySchedulerTraceSample,
};
...
pub use map::{
    ...
    Map, MapError, OBJECT_TYPE_COMPANY_HEADQUARTERS, OBJECT_TYPE_LIGHTHOUSE,
    OBJECT_TYPE_OWNED_LAND, OBJECT_TYPE_STATUE_COMPANY, OBJECT_TYPE_TRANSMITTER, OTTD_MP_RAILWAY,
    OTTD_MP_ROAD, OTTD_MP_TUNNELBRIDGE, OTTD_TILETYPE_TUNNELBRIDGE, RAIL_TB_CROSS, RAIL_TB_HORZ,
    RAIL_TB_LEFT, RAIL_TB_LOWER, RAIL_TB_RIGHT, RAIL_TB_UPPER, RAIL_TB_VERT, RAIL_TB_X, RAIL_TB_Y,
    RAIL_TILE_DEPOT, RAIL_TILE_NORMAL, RAIL_TILE_SIGNALS, RAIL_TOUCHING_SIDE_NE,
    RAIL_TOUCHING_SIDE_NW, RAIL_TOUCHING_SIDE_SE, RAIL_TOUCHING_SIDE_SW, RailFoundationDrawPlan,
    RailFoundationSpriteDraw, RailTrackDrawPlan, RailTrackSpritePass, SLOPE_NE, SLOPE_NW, SLOPE_SE,
    SLOPE_STEEP, SLOPE_SW, StationAnimationSound, TILE_PIXEL_HEIGHT, TREE_GROWTH_TICK_INTERVAL,
    Tile, TileCoord, TileKind, WaterClass, action2_eval_ctx_for_industry_tile_with_world,
    ...
    activate_house_lift_animation, add_house_animation_to_queue, advance_industry_animated_tiles,
    ...
    advance_newgrf_industry_animation_frames_with_world_and_cargo_catalog, airport_radar_frame,
    apply_desert_transition_from_visits, apply_seasonal_snow, bridge_foundation_for_axis,
    bridge_surface_slope_and_z, bubble_generator_spawns_from_visits, clear_tree,
    coord_from_linear_index, coord_to_dense_index, coord_to_linear_index, do_flood_tile,
    effective_rail_trackbits, effective_road_bits, flood_vehicles, foundation_draw_plan,
    ...
    is_industry_completed, is_map_object_tile, is_newgrf_object_type, is_newgrf_object_type_id,
    ...
    make_shore_tile, make_water_tile, make_water_tile_with_random_bits, object_footprint_at,
    object_footprint_tiles, object_id_from_tile, object_origin_from_tile, object_spec_id_from_tile,
    object_type_dims, object_type_dims_id, object_view_index_for_tile, object_view_index_for_type,
    openttd_tile_index_to_coord, opposite_diag_dir, partial_pixel_z, plant_tree,
    play_station_animation_sounds, process_water_flood_from_visits, rail_bit_for_sides,
    rail_bits_touching_side, rail_foundation_draw_plan, rail_foundation_for_trackbits,
    rail_signal_diag_dir_offset, rail_surface_slope_and_z, rail_tile_is_signals,
    rail_track_draw_plan, rail_trackbits_valid_on_slope, rail_traversal_bits, resolve_tunnel_end,
    ...
    step_industry_tiles_with_seed_and_catalog,
    ...
    step_newgrf_station_tiles, step_newgrf_station_tiles_with_towns_and_world_and_cargo_catalog,
    step_newgrf_station_tiles_with_towns_and_world_and_cargo_catalog_and_sounds,
    ...
    tree_or_field_stage, trigger_industry_randomisation_at,
    ...
    trigger_newgrf_station_animation_for_platform_with_towns_and_world_and_cargo_catalog_and_sounds,
    ...
    trigger_newgrf_station_animation_for_station_with_towns_and_world_and_cargo_catalog_and_sounds,
    ...
    trigger_newgrf_station_animation_with_towns_and_world_and_cargo_catalog_and_sounds,
...
pub use house_spec::{
    ...
    HOUSE_CALLBACK_ANIMATION_NEXT_FRAME_MASK, HOUSE_CALLBACK_ANIMATION_SPEED_MASK,
    HOUSE_CALLBACK_ANIMATION_TRIGGER_CONSTRUCTION_STAGE_CHANGED_MASK,
    HOUSE_CALLBACK_ANIMATION_TRIGGER_TILE_LOOP_MASK, HOUSE_CALLBACK_DESTRUCTION_MASK,
    ...
    get_translated_house_id, house_footprint_offsets, house_north_part, house_spec_def,
    next_free_house_id, pick_town_house_id, pick_town_house_id_with_catalog, resolve_house_draw_id,
    vanilla_or_newgrf_house,
};
pub use infrastructure::{
    ROAD_INFRASTRUCTURE_ROADTYPE_COUNT, RoadInfrastructureSummary, StationInfrastructureSummary,
    WaterInfrastructureSummary, road_infrastructure_for_company,
    road_infrastructure_for_company_with_stations, station_infrastructure_for_company,
...
pub use newgrf_actions::{
    ...
    apply_newgrf_action5_tramway, apply_newgrf_action5_tramway_default_dirs, apply_newgrf_badges,
...
pub use newgrf_callback::{
    AirportTextCallback, IndustryProductionCallbackResult, IndustryTileCargoAcceptance,
    ObjectFundMoreText, ObjectSlopeCallbackDiagnostic, ObjectSlopeCallbackOutcome,
    RoadStopCallbackWorld, StationSlopeCallbackDiagnostic, StationSlopeCallbackOutcome,
    Vehicle32DayCallback, VehicleAdvancedVisualEffect, VehicleAdvancedVisualEffectSpawn,
    VehicleColourMapping, VehicleRefitCostResult, VehicleSoundOverride,
    VehicleStartStopCallbackDiagnostic, VehicleStartStopCallbackOutcome, VehicleVisualEffectKind,
    VehicleVisualEffectSpec, action2_eval_ctx_from_station,
    action2_eval_ctx_from_station_with_spec, action2_eval_ctx_from_vehicle,
    ...
    apply_industry_location_callback, apply_industry_location_callback_for_build,
    apply_industry_production_callback, apply_industry_production_callback_with_catalog,
    apply_industry_tile_anim_callback, apply_industry_tile_autoslope_callback,
    apply_industry_tile_shape_callback_for_build, apply_object_slope_callback,
    apply_object_slope_callback_for_build, apply_road_stop_availability_callback,
    apply_road_stop_availability_callback_with_context, apply_station_availability_callback,
    apply_station_availability_callback_at,
    ...
    apply_station_availability_callback_with_spec, apply_station_slope_callback_for_build,
    apply_vehicle_start_stop_callback, callback_allows_8bit_boolean, callback_allows_location,
    callback_allows_placement, callback_draws_default_foundation, classify_object_slope_callback,
    classify_vehicle_start_stop_callback, decode_vehicle_refit_cost_result,
    ...
    resolve_airport_text_callback, resolve_callback_or_failed, resolve_cargo_profit_callback,
    resolve_cargo_station_rating_callback, resolve_house_animation_callback_with_world,
    resolve_house_callback_with_world, resolve_industry_decide_colour_callback,
    ...
    resolve_industry_tile_random_trigger, resolve_object_fund_more_text_callback,
    resolve_object_slope_callback, resolve_object_slope_callback_for_build,
    resolve_station_slope_callback_for_build, resolve_station_slope_callback_for_build_with_map,
    resolve_station_slope_callback_for_build_with_map_and_context, resolve_vehicle_32day_callback,
    resolve_vehicle_callback, resolve_vehicle_capacity_property_callback,
    resolve_vehicle_colour_mapping_callback, resolve_vehicle_colour_mapping_callback_with_ctx,
    ...
    resolve_vehicle_spawn_visual_effect_callback_with_ctx, resolve_vehicle_start_stop_callback,
    resolve_vehicle_visual_effect_callback, resolve_vehicle_visual_effect_spec_callback,
    resolve_vehicle_visual_effect_spec_callback_with_ctx, trigger_road_stop_animation,
    ...
    vehicle_tractive_effort, vehicle_visual_effect_kind, vehicle_visual_effect_spec,
    vehicle_visual_effect_spec_with_ctx, vehicle_weight_t,
    writeback_airport_tile_parent_persistent_registers, writeback_industry_persistent_registers,
...
pub use newgrf_sprites::{
    ...
    CATENARY_PYLON_SPRITE_BASE, CATENARY_WIRE_SPRITE_BASE, CBID_AIRPORT_ADDITIONAL_TEXT,
    CBID_AIRPORT_LAYOUT_NAME, CBID_AIRPTILE_ANIMATION_NEXT_FRAME, CBID_AIRPTILE_ANIMATION_SPEED,
    CBID_AIRPTILE_ANIMATION_TRIGGER, CBID_AIRPTILE_DRAW_FOUNDATIONS, CBID_CANALS_SPRITE_OFFSET,
    CBID_CARGO_PROFIT_CALC, CBID_CARGO_STATION_RATING_CALC, CBID_HOUSE_ALLOW_CONSTRUCTION,
    CBID_HOUSE_ANIMATION_NEXT_FRAME, CBID_HOUSE_ANIMATION_SPEED,
    CBID_HOUSE_ANIMATION_TRIGGER_CONSTRUCTION_STAGE_CHANGED,
    CBID_HOUSE_ANIMATION_TRIGGER_TILE_LOOP, CBID_HOUSE_DESTRUCTION, CBID_HOUSE_DRAW_FOUNDATIONS,
    CBID_INDTILE_ANIM_NEXT_FRAME, CBID_INDTILE_ANIMATION_NEXT_FRAME, CBID_INDTILE_ANIMATION_SPEED,
    CBID_INDTILE_ANIMATION_TRIGGER, CBID_INDTILE_AUTOSLOPE, CBID_INDTILE_DRAW_FOUNDATIONS,
    CBID_INDTILE_SHAPE_CHECK, CBID_INDUSTRY_DECIDE_COLOUR, CBID_INDUSTRY_INPUT_CARGO_TYPES,
    CBID_INDUSTRY_LOCATION, CBID_INDUSTRY_OUTPUT_CARGO_TYPES, CBID_INDUSTRY_SPECIAL_EFFECT,
    CBID_OBJECT_ANIMATION_NEXT_FRAME, CBID_OBJECT_ANIMATION_SPEED, CBID_OBJECT_ANIMATION_TRIGGER,
    CBID_OBJECT_AUTOSLOPE, CBID_OBJECT_COLOUR, CBID_OBJECT_FUND_MORE_TEXT,
    ...
    CBID_STATION_DRAW_TILE_LAYOUT, CBID_STATION_LAND_SLOPE_CHECK, CBID_VEHICLE_32DAY_CALLBACK,
    CBID_VEHICLE_AUTOREPLACE_SELECTION, CBID_VEHICLE_COLOUR_MAPPING, CBID_VEHICLE_MODIFY_PROPERTY,
    CBID_VEHICLE_SOUND_EFFECT, CBID_VEHICLE_START_STOP_CHECK, CBID_VEHICLE_VISUAL_EFFECT,
    DecodedSprite, FOUNDATION_ACTION5_SLOT_COUNT, GlobalSpriteGraphics, NEWGRF_SPRITE_BASE,
    ...
    TRAMWAY_DEPOT_NO_TRACK_ACTION5_SLOT, TRAMWAY_DEPOT_WITH_TRACK_ACTION5_SLOT,
    ...
    apply_company_colour_mask, bake_sprite_company_mask, bake_sprite_company_palette,
    bake_sprite_crash, bake_sprite_palette_map, bake_sprite_two_company_palette,
    bake_sprite_two_company_palette_with_map, bridge_decks_action5_base, bridge_decks_action5_slot,
    ...
    collect_global_sprite_graphics, collect_house_sprite_graphics,
...
pub use object_spec::{
    ...
    OBJECT_FLAG_CANNOT_REMOVE, OBJECT_FLAG_CLEAR_INCOME, OBJECT_FLAG_DRAW_WATER,
    OBJECT_FLAG_HAS_NO_FOUNDATION, OBJECT_FLAG_USES_2CC, OBJECT_SIZE_1X1, OWNED_LAND_COST_FACTOR,
...
pub use pathfinder::{
    PathCache, PathNetwork, ShipPathCost, TunnelWormholes, diag_dir_offset, find_path,
    find_path_cached, find_path_with_wormholes, find_rail_build_path, find_rail_path_for_engine,
    find_ship_path_cached, find_ship_path_cached_with_trackdir,
    find_ship_path_cached_with_trackdirs, find_ship_path_for_engine, find_ship_path_with_cost,
    find_ship_path_with_cost_and_trackdir, find_ship_path_with_cost_and_trackdirs,
    path_network_for_vehicle, ship_path_cost_for_path, ship_path_cost_for_path_with_trackdir,
    ship_path_cost_for_path_with_trackdirs, station_entrance_faces_rail,
...
pub use pathfinding_settings::{
    DEFAULT_PATH_BACKOFF_INTERVAL, DEFAULT_SHIP_CURVE45_PENALTY, DEFAULT_SHIP_CURVE90_PENALTY,
    DEFAULT_WAIT_FOR_PBS_PATH_DAYS, DEFAULT_WAIT_ONEWAY_SIGNAL_DAYS,
    DEFAULT_WAIT_TWOWAY_SIGNAL_DAYS, MAX_SHIP_CURVE_PENALTY, PBS_WAIT_FOREVER, PathfindingSettings,
};
...
pub use rail_type::{
    ...
    engine_compatible_with_rail, engine_compatible_with_rail_setting, engine_requires_electric,
    engine_requires_maglev, engine_requires_monorail, powered_railtypes_mask,
    powered_railtypes_mask_with_props, rail_build_cost_multiplier,
    rail_build_cost_multiplier_for_type, rail_type_bit, rail_type_default_cost_multiplier,
...
pub use refit::{
    next_refit_cargo, refit_allowed, refit_allowed_with_catalog,
    refit_allowed_with_catalog_and_climate, refittable_cargo_types,
    refittable_cargo_types_for_engine, refittable_cargo_types_for_engine_with_catalog,
...
pub use road_stop_spec::{
    ...
    ROADSTOP_FLAG_ROAD_ONLY, ROADSTOP_FLAG_TRAM_ONLY, ROADSTOP_LAYOUT_COUNT, ROADSTOP_TYPE_ALL,
    ROADSTOP_TYPE_BUS, ROADSTOP_TYPE_TRUCK, RSV_BAY_NE, RSV_BAY_NW, RSV_BAY_SE, RSV_BAY_SW,
    RSV_DRIVE_THROUGH_X, RSV_DRIVE_THROUGH_Y, RoadStopBridgeableInfo, RoadStopClassDef,
...
pub use station::{
    ...
    rail_station_approach_tile, rail_station_axis_y,
    rail_station_controller_stop_tile_for_platform_osl, rail_station_owned_tiles,
