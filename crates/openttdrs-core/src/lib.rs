...
pub use map::{
    ...
    OBJECT_TYPE_LIGHTHOUSE, OBJECT_TYPE_OWNED_LAND, OBJECT_TYPE_TRANSMITTER, OTTD_MP_RAILWAY,
    ...
    RAIL_TOUCHING_SIDE_NW, RAIL_TOUCHING_SIDE_SE, RAIL_TOUCHING_SIDE_SW, SLOPE_NE, SLOPE_NW,
...
pub use newgrf_sprites::{
    ...
    merge_tramway_action5_block, merge_twocc_action5_block, oneway_action5_slot,
