...
pub use map::{
    ...
    OBJECT_TYPE_STATUE_COMPANY, OBJECT_TYPE_TRANSMITTER, OTTD_MP_RAILWAY, OTTD_MP_ROAD,
    OTTD_MP_TUNNELBRIDGE, OTTD_TILETYPE_TUNNELBRIDGE, RAIL_TB_CROSS, RAIL_TB_HORZ, RAIL_TB_LEFT,
    ...
    SLOPE_STEEP, SLOPE_SW, TILE_PIXEL_HEIGHT, TREE_GROWTH_TICK_INTERVAL, Tile, TileCoord, TileKind,
...
pub use newgrf_sprites::{
    ...
    TRAMWAY_ACTION5_SLOT_COUNT, TWOCC_ACTION5_SLOT_COUNT, TrainSpriteAssign, TrainSpriteGraphics,
    action5_type_name, airport_preview_action5_slot, apply_company_colour_mask,
    bake_sprite_company_mask, bridge_decks_action5_base, bridge_decks_action5_slot,
    catenary_action5_local_slot, collect_action5_blocks, collect_airport_sprite_graphics,
