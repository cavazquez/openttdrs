...
pub use industry_spec::{
    ...
    INDUSTRY_NUM_INPUTS, INDUSTRY_NUM_OUTPUTS, INDUSTRY_ORIGINAL_NUM_INPUTS,
    INDUSTRY_ORIGINAL_NUM_OUTPUTS, INVALID_INDUSTRY, IndustryLayoutTile, IndustrySpecDef,
    IndustryTileLayout, NEW_INDUSTRY_OFFSET, NUM_INDUSTRY_TYPES, cargo_type_from_label,
    empty_industry_overrides, empty_industry_spec_catalog, get_cargo_translation,
    get_cargo_translation_for_climate, get_translated_industry_id, industry_spec_def,
    next_free_industry_id,
};
...
pub use map::{
    ...
    action2_eval_ctx_for_industry_tile_with_world, advance_industry_animated_tiles,
    advance_industry_construction, advance_industry_tile_animations,
    advance_industry_tile_loop_events,
    advance_industry_tile_randomisation_from_visits_with_catalog, airport_radar_frame,
    ...
    step_industry_tiles_with_seed_and_catalog, step_newgrf_station_tiles,
    step_newgrf_station_tiles_with_world, step_tree_and_field_growth, tick_tree_tile_loop,
...
pub use house_spec::{
    DEFAULT_HOUSE_AVAILABILITY, DEFAULT_HOUSE_PROBABILITY, HOUSE_YEAR_MAX, HouseLookup,
    HouseScopeCounts, HouseSpec, HouseSpecDef, INVALID_HOUSE, NEW_HOUSE_OFFSET, NUM_HOUSES,
...
pub use station::{
    ...
    station_type_from_m6, stop_kind_from_m6, train_on_rail_platform, update_station_ratings,
...
pub use train_consist::{
    ...
    consist_changed_with_map_and_catalog, consist_head_id, consist_occupied_tiles,
    consist_power_hp, consist_tile_span, consist_unit_ids, consist_unit_ids_indexed,
    consist_unit_poses, consist_weight_t, detach_unit, detach_unit_keep_tail,
    engine_is_train_engine, engine_is_wagon, enrich_vehicle_track_badge_vars,
    propagate_consist_unit_poses, reverse_consist_at_stop, same_consist, sell_chain_ids,
};
...
pub use world_gen::{
    ...
    PreserveRect, QuantitySeaLakes, TerrainType, TgenSmoothness, TownDensity, TreePlacement,
    TreePlacementOrigin, WorldGenConfig, WorldGenRng, apply_heightmap, apply_population_gen,
    apply_population_gen_with_rng, apply_world_gen, apply_world_gen_with_rng, ceil_div,
    clear_ground_m5, effective_clear_ground, generate_industries, generate_industries_with_rng,
