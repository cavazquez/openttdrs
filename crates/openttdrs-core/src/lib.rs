...
pub use newgrf_sprites::{
    ...
    bake_sprite_company_mask,
    build_grf_v2_action5_with_sprite, build_grf_v2_industry_tile_with_preview_sprite,
    ...
    build_grf_v2_train_with_action2_chain, build_grf_v2_train_with_preview_sprite,
    catenary_action5_local_slot, collect_action5_blocks,
