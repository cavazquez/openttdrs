...
pub use house_spec::{
    ...
    HOUSE_CALLBACK_ANIMATION_TRIGGER_TILE_LOOP_MASK, HOUSE_CALLBACK_DRAW_FOUNDATIONS_MASK,
    HOUSE_EXTRA_FLAG_CALLBACK_1A_RANDOM_BITS, HOUSE_EXTRA_FLAG_HISTORICAL,
    HOUSE_EXTRA_FLAG_PROTECTED, HOUSE_EXTRA_FLAG_SYNCHRONIZED_CALLBACK_1B, HOUSE_YEAR_MAX,
    HouseLookup, HouseScopeCounts, HouseSpec, HouseSpecDef, INVALID_HOUSE, NEW_HOUSE_OFFSET,
    NUM_HOUSES, action2_eval_ctx_for_house_tile, action2_eval_ctx_for_house_tile_with_counts,
...
pub use newgrf_callback::{
    ...
    resolve_industry_decide_colour_callback, resolve_industry_production_change_build_callback,
    resolve_industry_production_change_callback, resolve_industry_refuse_cargo_callback,
    resolve_industry_refuse_cargo_callback_with_catalog, resolve_industry_special_effect_callback,
...
pub use newgrf_sprites::{
    ...
    CBID_HOUSE_ANIMATION_TRIGGER_TILE_LOOP, CBID_HOUSE_DRAW_FOUNDATIONS,
    ...
    TWOCC_PALETTE_BASE, TrainSpriteAssign, TrainSpriteGraphics, action5_type_name,
