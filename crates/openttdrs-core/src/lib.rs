...
pub use newgrf_sprites::{
    ...
    CBID_INDUSTRY_SPECIAL_EFFECT, CBID_OBJECT_ANIMATION_NEXT_FRAME, CBID_OBJECT_ANIMATION_SPEED,
    CBID_OBJECT_ANIMATION_TRIGGER, CBID_OBJECT_AUTOSLOPE, CBID_OBJECT_COLOUR,
    CBID_OBJECT_FUND_MORE_TEXT, CBID_OBJECT_LAND_SLOPE_CHECK, CBID_STATION_ANIMATION_NEXT_FRAME,
