...
pub use industry_spec::{
    INDUSTRY_BEHAVIOUR_CARGO_TYPES_UNLIMITED_MASK, INDUSTRY_CALLBACK_DECIDE_COLOUR_MASK,
    INDUSTRY_CALLBACK_INPUT_CARGO_TYPES_MASK, INDUSTRY_CALLBACK_LOCATION_MASK,
    INDUSTRY_CALLBACK_MONTHLY_PROD_CHANGE_MASK, INDUSTRY_CALLBACK_OUTPUT_CARGO_TYPES_MASK,
    ...
    INDUSTRY_CALLBACK_REFUSE_CARGO_MASK, INDUSTRY_CALLBACK_SPECIAL_EFFECT_MASK,
