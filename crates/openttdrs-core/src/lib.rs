...
pub use newgrf_callback::{
    ...
    callback_draws_default_foundation, decode_vehicle_refit_cost_result,
...
pub use newgrf_sprites::{
    ...
    CBID_OBJECT_ANIMATION_TRIGGER, CBID_OBJECT_COLOUR, CBID_OBJECT_LAND_SLOPE_CHECK,
...
pub use object_spec::{
    ...
    OBJECT_CALLBACK_COLOUR_MASK, OBJECT_CALLBACK_SLOPE_CHECK_MASK, OBJECT_FLAG_ANIM_RANDOM_BITS,
    OBJECT_FLAG_ANIMATION, OBJECT_SIZE_1X1, ObjectSpecDef, empty_object_spec_catalog,
