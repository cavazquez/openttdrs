...
pub use newgrf_callback::{
    ...
    resolve_vehicle_start_stop_callback, resolve_vehicle_visual_effect_callback,
    resolve_vehicle_visual_effect_spec_callback, trigger_road_stop_animation,
    ...
    vehicle_weight_t, writeback_airport_tile_parent_persistent_registers,
