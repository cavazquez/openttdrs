...
pub use object::{
    ...
    OBJECT_TYPE_TRANSMITTER, OTTD_MP_OBJECT, ObjectAnimationTrigger, ObjectScopeCounts,
    action2_eval_ctx_for_object_tile, action2_eval_ctx_for_object_tile_with_counts,
    action2_eval_ctx_for_object_tile_with_map, action2_eval_ctx_for_object_tile_with_towns,
    action2_eval_ctx_for_object_tile_with_world, apply_object_autoslope_callback,
    ...
    object_view_index_for_type, resolve_object_colour_callback, step_newgrf_object_tiles,
    trigger_newgrf_object_animation,
};
pub use rail_bits::{
