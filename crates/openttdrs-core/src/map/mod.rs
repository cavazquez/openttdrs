...
pub use house_lift::{
    LIFT_MAX_POSITION, LiftStep, activate_house_lift_animation, add_house_animation_to_queue,
...
pub use object::{
    MP_OBJECT_MAPT, OBJECT_TYPE_COMPANY_HEADQUARTERS, OBJECT_TYPE_LIGHTHOUSE,
    OBJECT_TYPE_OWNED_LAND, OBJECT_TYPE_STATUE_COMPANY, OBJECT_TYPE_TRANSMITTER, OTTD_MP_OBJECT,
    ObjectAnimationTrigger, ObjectScopeCounts, action2_eval_ctx_for_object_tile,
    ...
    apply_object_autoslope_callback, is_map_object_tile, is_newgrf_object_type,
    is_newgrf_object_type_id, is_owned_land_tile, object_footprint_at, object_footprint_tiles,
    object_id_from_tile, object_origin_from_tile, object_origin_from_tile_with_objects,
    ...
    resolve_object_colour_callback, step_newgrf_object_tiles, trigger_newgrf_object_animation,
};
pub use rail_bits::{
...
pub use station_tile_anim::{
    AIRPORT_RADAR_FRAMES, StationAnimationSound, airport_radar_frame, is_airport_tower_tile,
    play_station_animation_sounds, step_airport_tiles, step_newgrf_airport_tiles,
    step_newgrf_airport_tiles_with_towns, step_newgrf_airport_tiles_with_towns_and_airport_catalog,
    ...
    trigger_newgrf_airport_animation_for_station_with_towns_and_cargo_catalog_and_airport_catalog_and_sounds,
    trigger_newgrf_airport_animation_for_station_with_towns_and_cargo_catalog_and_airport_catalog_and_sounds_with_snow_line,
    trigger_newgrf_airport_animation_for_station_with_towns_and_cargo_catalog_and_airport_catalog_and_sounds_with_snow_line_and_overrides,
    trigger_newgrf_airport_animation_for_station_with_towns_and_cargo_catalog_and_airport_catalog_with_global_rng,
    trigger_newgrf_airport_animation_for_station_with_towns_and_cargo_catalog_and_airport_catalog_with_global_rng_and_sounds,
    ...
    trigger_newgrf_airport_animation_for_station_with_towns_and_cargo_catalog_and_airport_catalog_with_global_rng_and_sounds_with_snow_line_and_overrides,
...
pub use water_class::{
    WaterClass, clear_tile_after_native_water_restore, effective_water_class_for_ship,
    has_tile_water_ground, is_canal_tile, is_coast_tile, is_river_tile, make_water_tile,
    make_water_tile_with_random_bits, river_tile_is_ship_navigable, set_water_class_m1,
    tile_has_water_class, water_class, water_class_after_native_clear, water_class_from_m1,
};
pub use water_flood::{
...
mod ottdmap_binary_tests {
    ...
    fn mp_tunnelbridge_maps_to_tunnel_and_bridge_kinds() {
        ...
        let water_bridge = build_ottdmap_2x2(
            [0x90, 0, 0, 0],
            base.0,
            base.1,
            base.2,
        ...
        let map = Map::from_ottd_binary(&water_bridge).expect("map");
        assert_eq!(
            map.get(TileCoord::new(0, 0)).expect("t").kind,
            TileKind::Water
        );
