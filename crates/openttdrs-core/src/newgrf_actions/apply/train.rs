...
fn push_feature_vehicles(
    ...
    for meta in metas {
        ...
        catalog.push(EngineDef {
            ...
            mail_capacity: meta.mail_capacity,
            cargo,
            ...
            extra_flags: meta.extra_flags,
            no_default_cargo_multiplier: meta.no_default_cargo_multiplier,
            no_breakdown_smoke: meta.no_breakdown_smoke,
            ...
            ctt_include_cargos,
            ctt_exclude_cargos,
            cargo_classes_allowed: meta.cargo_classes_allowed,
            cargo_classes_disallowed: meta.cargo_classes_disallowed,
            cargo_classes_required: meta.cargo_classes_required,
            cargo_classes_specified: meta.cargo_classes_specified,
            ...
            newgrf_runtime,
            newgrf_grfid: grfid,
            newgrf_grf_version: grf_version,
            newgrf_type_tables: (!cargo_tables.is_empty()).then_some(cargo_tables.clone()),
