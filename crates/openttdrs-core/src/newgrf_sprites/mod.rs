...
pub use model::{
    ...
    Action2VarOp, Action2VarTerm, Action5Block, CALLBACK_FAILED,
    CBID_AIRPTILE_ANIMATION_NEXT_FRAME, CBID_AIRPTILE_ANIMATION_SPEED,
    CBID_AIRPTILE_ANIMATION_TRIGGER, CBID_AIRPTILE_DRAW_FOUNDATIONS, CBID_CARGO_PROFIT_CALC,
    CBID_CARGO_STATION_RATING_CALC, CBID_HOUSE_ALLOW_CONSTRUCTION, CBID_HOUSE_ANIMATION_NEXT_FRAME,
    CBID_HOUSE_ANIMATION_SPEED, CBID_HOUSE_ANIMATION_TRIGGER_CONSTRUCTION_STAGE_CHANGED,
    CBID_HOUSE_ANIMATION_TRIGGER_TILE_LOOP, CBID_HOUSE_DRAW_FOUNDATIONS, CBID_INDTILE_ACCEPT_CARGO,
    CBID_INDTILE_ANIM_NEXT_FRAME, CBID_INDTILE_ANIMATION_NEXT_FRAME, CBID_INDTILE_ANIMATION_SPEED,
    CBID_INDTILE_ANIMATION_TRIGGER, CBID_INDTILE_AUTOSLOPE, CBID_INDTILE_CARGO_ACCEPTANCE,
    CBID_INDTILE_DRAW_FOUNDATIONS, CBID_INDTILE_SHAPE_CHECK, CBID_INDUSTRY_DECIDE_COLOUR,
    CBID_INDUSTRY_INPUT_CARGO_TYPES, CBID_INDUSTRY_LOCATION, CBID_INDUSTRY_MONTHLY_PROD_CHANGE,
    CBID_INDUSTRY_OUTPUT_CARGO_TYPES, CBID_INDUSTRY_PROD_CHANGE_BUILD,
    CBID_INDUSTRY_PRODUCTION_CHANGE, CBID_INDUSTRY_REFUSE_CARGO, CBID_INDUSTRY_SPECIAL_EFFECT,
...
mod tests {
    ...
    #[test]
    fn house_animation_callback_ids_match_native_contract() {
        assert_eq!(CBID_HOUSE_ANIMATION_NEXT_FRAME, 0x1A);
        assert_eq!(CBID_HOUSE_ANIMATION_TRIGGER_TILE_LOOP, 0x1B);
        assert_eq!(
