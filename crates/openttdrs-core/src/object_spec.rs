...
/// Bit `Uses2CC` de `ObjectFlag` (Action0 `0x10`). El color de la instancia
/// guarda `colour1 + colour2 * 16` para las dos rampas de la librea.
pub const OBJECT_FLAG_USES_2CC: u16 = 1 << 8;
