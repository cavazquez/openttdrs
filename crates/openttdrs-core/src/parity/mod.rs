...
pub use scenario::{
    ...
    TRAIN_LINE_STATION_A, TRAIN_LINE_STATION_B, TRAIN_LINE_VEHICLE_ID, TRAIN_PBS_GOAL_X,
    TRAIN_PBS_NORTH_ID, TRAIN_PBS_NORTH_Y, TRAIN_PBS_PATH_A, TRAIN_PBS_PATH_B, TRAIN_PBS_SOUTH_ID,
    TRAIN_PBS_SOUTH_Y, TRAIN_SIGNAL_BLOCK_TILE, TRAIN_SIGNAL_BLOCKER_ID, TRAIN_SIGNAL_LEAD_ID,
    TRAIN_SIGNAL_TILE, TRAIN_SUPPLY_BLOCK_TILE, TRAIN_SUPPLY_BLOCKER_ID, TRAIN_SUPPLY_FACTORY,
