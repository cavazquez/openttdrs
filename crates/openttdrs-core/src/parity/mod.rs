...
pub use scenario::{
    ...
    FIRST_ROUTE_WORLD_SEED, FIRST_ROUTE_YEAR, RAIL_SIGNALS_MIXED_TYPES, RAIL_SIGNALS_MIXED_Y,
    ...
    TRAIN_SUPPLY_VEHICLE_ID, TRAIN_SUPPLY_WAIT_SIGNAL, TRUCK_BAY_DELIVER_ROAD,
    TRUCK_BAY_DELIVER_STOP, TRUCK_BAY_LOAD_ROAD, TRUCK_BAY_LOAD_STOP, TRUCK_BAY_VEHICLE_ID,
    build_ai_rival_line, build_first_route, build_rail_signals_mixed, build_scenario,
