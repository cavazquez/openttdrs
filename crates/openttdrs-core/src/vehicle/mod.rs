...
pub use model::{
    AircraftPhase, DIR_E, DIR_N, DIR_NE, DIR_NW, DIR_S, DIR_SE, DIR_SW, DIR_W, TimetableWaitKind,
    Vehicle, VehicleDirection, VehicleKind,
};

// Re-exportaciones públicas desde order.rs
pub use order::{MAX_VEHICLE_NAME_CHARS, OrderConditionKind, VehicleOrder};
