...
| NewGRF | **Media de parseo / media de runtime** | Catálogos Action0/3/5 amplios; call sites reales limitados a CB24, CB13 de stations/RoadStops, CB31, CB17, CB28 y CB25–27. Residual: resto CBIDs/scopes/storage y validación diferencial; ver las [matrices Action0/3/5](parity/newgrf-action0-matrix.md) y de [callbacks](parity/newgrf-callback-matrix.md) |
