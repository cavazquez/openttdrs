...
Actualización aeroportuaria #326 (2026-09-07): el selector de construcción
X/Y ya conserva el layout Action0 N/E (o S/O del mismo eje), su índice y su
rotación en `STNN`, y rehidrata offsets `(x,y)` sin transponerlos. Esto no
resuelve foundations Action5 ni la rotación runtime de sprites/children; la
evidencia canónica y los límites están en
