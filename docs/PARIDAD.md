...
de vehículos se traducen con GlobalVar `0x18` y alimentan las variables `0x64`
`0x7A`; sigue pendiente la variable `0x65` dependiente del tipo de vía. Siguen
...
Las listas nativas de badges de vehículos (`0x33`/`0x2A`/`0x26`/`0x24`) ya se
traducen con GlobalVar `0x18`, se guardan en `EngineDef` y alimentan las
variables Action2 `0x64`/`0x7A`; `0x65` aún depende de badges en tipos de vía.
