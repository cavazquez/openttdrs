...
Corrección del renglón NewGRF en este corte (`c88518c4`): el writeback de
...
tick. El residual real es `CargoDistributed`/`ConstructionStageChanged`,
además de scopes y mutaciones aún parciales.
