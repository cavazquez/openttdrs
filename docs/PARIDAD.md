...
| NewGRF | **Media de parseo / media de runtime** | Catálogos Action0/3/5 amplios; Action5 sigue sus ramas de paisaje/`param[]` durante la carga; call sites reales CB24, CB13 de stations/RoadStops, CB31, CB17, CB28, CB25–27 y el scheduler parcial RoadStop CB140–142. Residual: resto CBIDs/scopes/storage, triggers/sprites dinámicos RoadStop y validación diferencial; ver las [matrices Action0/3/5](parity/newgrf-action0-matrix.md) y de [callbacks](parity/newgrf-callback-matrix.md) |
