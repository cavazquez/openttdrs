...
| NewGRF | **Media de parseo / media de runtime** | Catálogos Action0/3/5 amplios; Action5 sigue sus ramas de paisaje/`param[]` durante la carga; call sites reales CB24, CB13/CB14/CB149 y CB140–142 de stations (carga/descarga de cargo, plataforma ferroviaria y CTT incluidos), CB13 y scheduler parcial CB140–142 de RoadStops, CB31, CB17, CB28, CB25–27. Residual: resto CBIDs/scopes/storage, triggers/sprites dinámicos RoadStop, llegadas/salidas/aceptación/reserva, sonidos y scopes completos de Stations, además de validación diferencial; ver las [matrices Action0/3/5](parity/newgrf-action0-matrix.md) y de [callbacks](parity/newgrf-callback-matrix.md) |
