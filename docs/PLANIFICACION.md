...
actualizado el **2026-09-18**, con entregas #568–#573 y tareas pendientes
#574–#577. La
...
| **P3.6** | Renovación de casas · hecho | Las casas no envejecen | Tras `minimum_life` y al vencer `time_until_rebuild`, `TileLoop_Town` reutiliza `r = Random()`, programa `GB(r,16,8)+192`, limpia la huella y sólo intenta reponerla si `GB(r,24,8) >= 12` (`town_cmd.cpp:671-745`) | Ejecutar el clear/rebuild dentro de la visita LFSR, después de carga, sin una segunda chance/RNG | L · **hecho** |
