...
| Snap V1 | [parity/snap-v1.md](parity/snap-v1.md) | Build read-only, smoke aislado y evidencia del paquete Snap |
...
| [parity/snap-v1.md](parity/snap-v1.md) | Build y smoke verificable del paquete Snap |
