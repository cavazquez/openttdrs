...
- Catenaria OpenGFX (wires 1039–1062): plano + pendientes X/Y; PCP por vecinos
  electrificados + ignore cada 2 teselas (`_ignored_pcp`).
- Pendiente: postes PPP sueltos, túneles/puentes, transparencia TO_CATENARY.
