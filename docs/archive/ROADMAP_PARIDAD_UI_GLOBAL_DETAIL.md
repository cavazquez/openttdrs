# Roadmap global de paridad UI con OpenTTD — DETALLE (archivo)

Fecha base: **2026-07-10** · Archivado: **2026-07-17**  
Estado: **histórico** — inventario UI-0…UI-8 y checklists.  
Fuente viva de siguiente corte: [../ROADMAP_PARIDAD_UI_GLOBAL.md](../ROADMAP_PARIDAD_UI_GLOBAL.md).

Referencia original: `reference/openttd-upstream/src/`

Documentos relacionados:

- [../ROADMAP_PARIDAD_ESTRUCTURAL.md](../ROADMAP_PARIDAD_ESTRUCTURAL.md)
- [ROADMAP_MENUS_UI.md](ROADMAP_MENUS_UI.md) (mismo archive)
- [../parity/ui_windows_parity.md](../parity/ui_windows_parity.md)
- [ROADMAP_NEWS_STATUSBAR.md](ROADMAP_NEWS_STATUSBAR.md)
...
- [x] LinkGraphLegend. *(ventana + filtro cargo/vista; overlay mapa gizmos ✅)*
...
CargoDist MVP (#49) ✅; paridad MCF nivel 2 (`linkgraph_parity`) ✅; LGRP save ✅ / overlay mapa ✅; LGRJ async → OOS.
...
- [x] Multi-compañía polish ownership: `m1` en vía/carretera/depósitos, render por owner, guards flota.
...
- [x] GameScript: story, goals, league. *(#43 MVP GS-lite Rust; Squirrel OOS — `docs/archive/epics/gamescript.md`)*
...
`archive/ROADMAP_MENUS_UI.md` y `parity/ui_windows_parity.md` contienen snapshots de
...
10. ~~Segunda humana local~~ wontfix (#41). MP humanas → #21. tram `m3` → OOS.
...
10. ~~Action1/3 RoadTypes → in-world plano (vista por `road_bits`; sin pendientes/tram overlay).~~ ✅
...
4. ~~CargoDist paridad MCF nivel 2 (`linkgraph_parity`).~~ ✅ — LGRP save ✅ / overlay mapa ✅; LGRJ async → OOS.
...
CargoDist MVP + MCF nivel 2 ✅; LGRP save ✅ / overlay mapa ✅; LGRJ async → OOS. NewGRF Action0–14 / parámetros → OOS.
