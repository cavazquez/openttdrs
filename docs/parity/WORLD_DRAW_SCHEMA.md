...
eléctrico, ya reasignan sus slots locales de profundidad con ese vector final.
Aplicar el vector global a las demás entidades, children y overlays sigue
siendo trabajo de composición posterior. Atlas, pivotes, clipping,
transparencias y píxeles siguen perteneciendo al contrato raster.
