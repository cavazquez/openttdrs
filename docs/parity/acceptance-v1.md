...
- **V1-AIR — [#594](https://github.com/cavazquez/openttdrs/issues/594):** Dakota vanilla entre dos Country, primera entrega pagada y auditoría de bloques FTA sin huérfanos ([evidencia](air-delivery-v1.md)); a la espera de CI remota vigente antes del cierre.
- **V1-NET — [#595](https://github.com/cavazquez/openttdrs/issues/595):** dedicated, dos clientes y late join, 2.000 ticks; el segundo entra en 500, se comparan hash/log/issuer por tick y la [evidencia TCP](late-join-v1.md) conserva SHA, primer desacuerdo y conteos. Implementado; espera CI remota vigente antes del cierre. Depende de V1-NETG.
...
- **V1-GS — [#599](https://github.com/cavazquez/openttdrs/issues/599):** una meta `Coal=10` de TransCargo guarda en 5/10, continúa 2.000 ticks contra la rama JSON y conserva hash/noticia única ([evidencia](gs-json-v1.md)). Implementado; espera CI remota vigente antes del cierre. Depende de V1-GSCOUNT.
