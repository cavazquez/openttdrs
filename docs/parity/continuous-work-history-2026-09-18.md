# Historial de paridad hasta el 2026-09-18

Registro histórico, archivado al redefinir la dirección del proyecto. Las
prioridades, frases «siguiente etapa» y estados de issues que aparecen aquí
corresponden a cada fecha; no autorizan trabajo nuevo ni describen el backlog
actual. El [plan vigente](continuous-work-plan.md) y la
[auditoría](../audits/2026-09-18-direction.md) explican la nueva selección.
Se conserva junto a las matrices para mantener sus enlaces relativos.
