...
Última etapa RMAP-049 (cerrada): el constructor `DoCreateTown` ejecuta la
traza completa de la primera ciudad de `1330935378`, hasta
`[3221856382,229218699]`, la entrada exacta al siguiente `GenerateTownName`.
La matriz baja a 137 teselas/25 bloques en esa seed, pero sube a 392/65 en
`1330935379`; RMAP-050 queda abierto para explicar y corregir ese contraejemplo
antes de extender la afirmación a otros pueblos.
