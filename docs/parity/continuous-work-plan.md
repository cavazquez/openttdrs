...
Última etapa RMAP-047 (cerrada): la ventana 61–72 de `GrowTown` conserva dos
casas —incluida la terminada sin población—, cuatro calles y seis retornos
hasta la frontera `[4159791342,1546280518]` (entrada de la 73). Es progreso
del walker aislado, no una mejora de la métrica global mientras RMAP-030 no
sustituya el constructor MVP.
