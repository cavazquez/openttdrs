...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005/RMAP-006/RMAP-007/RMAP-008/RMAP-009/RMAP-010/RMAP-011/RMAP-012/RMAP-013/RMAP-014/RMAP-015 cerrados; RMAP-016 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². El oráculo RMAP-013 ya exporta `world-raw` directo en cada frontera; RMAP-014 añadió el lado Rust preclear y reveló que la primera divergencia está ya en `landscape`. RMAP-015 reprodujo las 256 pasadas `RunTileLoop` post-río con tick fijo y redujo 64²/seed `1330935378` de 1177/117 bloques a 356/73. RMAP-016 toma el contrato `MakeSea`/`MakeShore` por pendiente, pues el residuo de agua aún concentra `type`/`m1`/`m5` y condiciona `m3`. El pre/post RMAP-007 deja `GenerateTrees` vanilla exacto en los cuatro climas. No confundir esos cierres aislados con la entrada que produce el generador propio. Cerrar RMAP-004 sólo cuando el mismo seed no tenga divergencias no explicadas en paisaje, clear, población, objetos y bytes de tesela. |
