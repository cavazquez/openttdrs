...
Última etapa RMAP-044 (cerrada): la casa interior de curva conserva
`TileAddByDir` y permite reproducir las llamadas 17–29 de `GrowTown`; la
frontera queda `[2375691898,265796979]`. Es progreso del walker aislado, no
una mejora de la métrica global mientras RMAP-030 no sustituya el constructor
MVP.
