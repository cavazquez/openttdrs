...
Última etapa RMAP-055 (cerrada): GDB y una regresión productiva fijan el
stream compartido justo al entrar en `GenerateIndustries`: `[11204508,
1784072412]` y `[2992974009,1778840233]` para las dos seeds 64². Esto prueba
que la divergencia siguiente no procede de pueblos; la matriz la sitúa en
industrias. RMAP-056 queda abierto para sus probabilidades tierra/agua y
