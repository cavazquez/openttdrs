...
RMAP-094/RMAP-095 extienden el mismo corte a la semilla ártica `1330935378`,
incluyendo línea de nieve, bancos `OnlyInTown` y bytes de `MakeIndustry`, sin
cerrar las demás semillas/climas.
RMAP-056 conserva
