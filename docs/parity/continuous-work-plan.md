...
Última etapa RMAP-068: la plantación de Farm replica ahora el orden de RNG,
la geometría y las cercas de OpenTTD. Así OilWells e IronOreMine vuelven a los
sitios nativos en las dos seeds 64²; RMAP-064 conserva los bytes nativos y
RMAP-056 la selección tierra/agua. No se declara paridad de industrias ni se
