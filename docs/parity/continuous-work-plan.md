...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005/RMAP-006/RMAP-007/RMAP-008/RMAP-009/RMAP-010/RMAP-011/RMAP-012/RMAP-013/RMAP-014/RMAP-015/RMAP-016/RMAP-017/RMAP-019/RMAP-020/RMAP-021/RMAP-022/RMAP-023/RMAP-025/RMAP-026/RMAP-028/RMAP-029/RMAP-031/RMAP-033/RMAP-035/RMAP-036/RMAP-037/RMAP-038/RMAP-039/RMAP-040/RMAP-041/RMAP-042/RMAP-043/RMAP-044/RMAP-045/RMAP-046/RMAP-047/RMAP-048/RMAP-049/RMAP-050/RMAP-051/RMAP-052/RMAP-053 cerrados; RMAP-018/RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². El oráculo RMAP-013 ya exporta `world-raw` directo en cada frontera. RMAP-015/016/017 reprodujeron el tile loop y la topología de costa; RMAP-020 separó el pozo largo de 64² y RMAP-022 alineó sus intentos `RandomTile` con el stream global. Por eso `landscape` y `clear` ya son exactos en ambas seeds 64² (0 teselas y 0/256 bloques 4×4), incluido el `m3` de RMAP-019. RMAP-025 iguala el total sugerido, RMAP-026 el primer selector, RMAP-028 el sorteo de tamaño/ciudad, RMAP-029 el primer bloque municipal con sus bytes nativos, RMAP-031 la primera extracción ponderada de casa, RMAP-033 el bytecode/azar de construcción de una 1×1, RMAP-035 la escritura atómica de sus huellas, RMAP-036 su geometría runtime, RMAP-037 la validación/reubicación, RMAP-038 el pool mutable vanilla y RMAP-039–048 su traza inicial. RMAP-049 reemplaza la trama MVP por `DoCreateTown`; RMAP-051 limpia sus ramas viales y RMAP-053 porta el fallback descendente de `LevelTownLand`. La primera ciudad de `1330935379` ya iguala 78 casas temporales, población 1862 y su frontera RNG; la matriz de `towns` queda en 132/24 para `1330935378` y exacta (0/0) para `1330935379`. No se declara mejora uniforme ni paridad global. RMAP-030/RMAP-032/RMAP-034 conservan las reglas generales de vialidad, callbacks y huellas; RMAP-027 la secuencia multi-pueblo. RMAP-018 sigue abierto para el creador completo de ríos en mapas donde el original sí los construye. RMAP-004 no se cierra mientras queden bytes distintos. El pre/post RMAP-007 deja `GenerateTrees` vanilla exacto en los cuatro climas. |
...
Última etapa RMAP-053 (cerrada): la fundación de pueblos modela ahora las dos
alternativas básicas de `LevelTownLand`. Si elevar las esquinas bajas toca una
calle compartida, valida el fallo y baja las esquinas altas, como
`TerraformTownTile`. La primera ciudad de `1330935379` conserva así la casa 16
de `(41,10)`, sus 78 casas temporales, población 1862 y RNG
`[3848068084,748657221]`; `towns` es exacta (0 teselas/0 bloques 4×4) para esa
seed y queda en 132/24 para `1330935378`. RMAP-050/RMAP-052 se cierran con esa
evidencia; RMAP-027/RMAP-030/RMAP-032/RMAP-034 permanecen abiertos para pueblos
posteriores, terreno general, callbacks y huellas multitile.
