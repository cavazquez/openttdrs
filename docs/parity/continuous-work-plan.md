...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005–017, RMAP-019–023, RMAP-025–026, RMAP-028–029, RMAP-031, RMAP-033, RMAP-035–055 y RMAP-057–058 cerrados; RMAP-018/RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034/RMAP-056/RMAP-059 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². `landscape`, `clear` y ahora `towns` son exactos (0 teselas/0 bloques 4×4) para las seeds 64² `1330935378` y `1330935379`; RMAP-054 alineó costa/`HasTileWaterGround`, RMAP-055 fijó la frontera RNG de industrias, RMAP-057 ordenó el catálogo/roster y RMAP-058 conserva las cuatro palabras RNG de cada intento. RMAP-059 toma las industrias force-one; RMAP-056 conserva la selección tierra/agua. La descripción y evidencia detallada se mantiene únicamente en `random-map-issues.md`, para no duplicar métricas. RMAP-004 sigue abierto mientras haya divergencias en otros tamaños/fases; RMAP-018 conserva el trazado completo de ríos y RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034 la generalización de pueblos. |
...
Última etapa RMAP-058 (cerrada): cada intento de industria consume el mismo
prefijo de cuatro palabras que `PlaceIndustry`/`CreateNewIndustry` y mantiene
la especie durante sus reintentos. No altera aún la lista force-one ni las
probabilidades: RMAP-059 toma las diez colocaciones try-hard y RMAP-056 sigue
