...
RMAP-094/RMAP-095/RMAP-096 extienden el mismo corte a las semillas árticas
`1330935378` y `1330935379`, incluyendo línea de nieve, bancos `OnlyInTown`,
bytes de `MakeIndustry` y costas de plataforma; ambas quedan exactas hasta
`industries`, sin cerrar `1330935381` ni las demás semillas/climas.
RMAP-056 conserva
