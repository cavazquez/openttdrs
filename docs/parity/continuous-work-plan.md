...
- Sub-issue RMAP-117: la limpieza de carreteras municipales distingue la
  ...
  cuatro semillas y Toyland 512² queda aislado como la siguiente divergencia
  de paisaje (4 teselas/4 bloques 4×4 en la seed `1330935378`). RMAP-118
  corrige el consumo del RNG global de árboles durante `CreateRivers` en
  Toyland; esa misma seed 512² queda exacta en `landscape` y `clear`, y la
  primera divergencia pasa a `towns` (8.956 teselas/1.344 bloques 4×4).
