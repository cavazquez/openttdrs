...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005/RMAP-006/RMAP-007/RMAP-008/RMAP-009/RMAP-010/RMAP-011/RMAP-012/RMAP-013/RMAP-014/RMAP-015/RMAP-016/RMAP-017/RMAP-019/RMAP-020 cerrados; RMAP-018/RMAP-021 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². El oráculo RMAP-013 ya exporta `world-raw` directo en cada frontera. RMAP-015/016/017 reprodujeron el tile loop y la topología de costa; RMAP-020 separó el pozo largo de 64² y no materializa una ruta incompleta. Por eso `landscape` ya es exacto en ambas seeds 64² (0 teselas y 0/256 bloques 4×4), incluido el `m3` de RMAP-019. La primera divergencia está ahora en `clear`: 264/107 bloques para `1330935378` y 230/127 para `1330935379`, todos bytes `m5`; RMAP-021 toma el stream/recorrido rough-rocky. RMAP-018 sigue abierto para el creador completo de ríos en mapas donde el original sí los construye. RMAP-004 no se cierra mientras queden bytes distintos. El pre/post RMAP-007 deja `GenerateTrees` vanilla exacto en los cuatro climas. |
