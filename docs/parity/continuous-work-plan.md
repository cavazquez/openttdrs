...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005/RMAP-006/RMAP-007/RMAP-008/RMAP-009/RMAP-010/RMAP-011/RMAP-012 cerrados; RMAP-013 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². La comparación por etapas confirma TGP crudo, ajuste de nivel, costas, suavizados y seno idénticos en 65×65 puntos para la semilla de referencia. El oráculo pre/post de RMAP-007 ya deja la fase `GenerateTrees` vanilla exacta en los cuatro climas, cuatro seeds 64² y un 128² (incluye nieve ártica, trópico y Toyland); no confundir ese cierre aislado con la entrada que produce el generador propio. Sigue RMAP-013: snapshots de las fases previas para localizar la primera divergencia real. Cerrar sólo cuando el mismo seed no tenga divergencias no explicadas en clear, población, objetos y bytes de tesela. |
