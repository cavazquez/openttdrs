...
| 7 | Idiomas y settings (#331) | Abierto | Catálogo de idiomas, locale, settings y textos guardados se cargan y se comparan con OpenTTD sin colisiones ECS ni regresiones de UI. Los cortes #448 y #449 localizan las cuatro frases estáticas de recesión y los seis headlines estáticos de desastres en ticker/popup, dejando explícitamente sin traducir los cuerpos y textos parametrizados; siguen pendientes las plantillas de NewsItem y el resto de catálogos `.lng`. |
