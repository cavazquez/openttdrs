...
Última etapa RMAP-062 (parcial): después de aceptar una industria vanilla, el
generador aplica los conflictos vanilla representables con `DistanceMax <= 14`
y limita una misma especie al pueblo Manhattan más cercano cuando el setting
por defecto lo exige. La cadena inicial carbón→central ya coincide en posición,
pero RMAP-064 debe escribir los bytes nativos y RMAP-062 conserva abierta la
asociación persistida/NewGRF. RMAP-056 sigue abierto para tierra/agua y
selección ponderada, sin declarar paridad de industrias ni cerrar
RMAP-004/RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034.
