...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005/RMAP-006/RMAP-007/RMAP-008/RMAP-009/RMAP-010/RMAP-011/RMAP-012/RMAP-013/RMAP-014 cerrados; RMAP-015 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². El oráculo RMAP-013 ya exporta `world-raw` directo en cada frontera; RMAP-014 añadió el lado Rust preclear y reveló que la primera divergencia está ya en `landscape` (1177 teselas/117 bloques 4×4 en 64² seed `1330935378`). El residuo dominante es `m3` de agua tras `CreateRivers`: RMAP-015 reproduce las 256 pasadas `RunTileLoop` de paisaje antes de volver a atribuir diferencias a TGP, costas o clear. El pre/post RMAP-007 deja `GenerateTrees` vanilla exacto en los cuatro climas. No confundir esos cierres aislados con la entrada que produce el generador propio. Cerrar RMAP-004 sólo cuando el mismo seed no tenga divergencias no explicadas en paisaje, clear, población, objetos y bytes de tesela. |
