...
- Aeropuertos NewGRF: los layouts `Airports` conservan el `gfx` global de cada
  ...
  Callbacks de animación/FTA, rotaciones runtime y aeropuertos importados desde
  SAV siguen pendientes y mantienen abierto #329.
