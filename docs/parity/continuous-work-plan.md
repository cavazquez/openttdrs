...
Base funcional publicada en `origin/main`: **`bd3ea9c1`** (`newgrf: persist town
PSA from house construction`). Este handoff documental se publica inmediatamente
...
Última validación de `bd3ea9c1`: `cargo fmt --all -- --check`, clippy estricto
