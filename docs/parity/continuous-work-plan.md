...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005–017, RMAP-019–023, RMAP-025–026, RMAP-028–029, RMAP-031, RMAP-033, RMAP-035–055, RMAP-057–058, RMAP-060, RMAP-063–064, RMAP-066–080 y RMAP-083 cerrados; RMAP-018/RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034/RMAP-056/RMAP-059/RMAP-061/RMAP-062/RMAP-065/RMAP-081/RMAP-082 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². RMAP-080 amplía la cohorte urbana exacta a 256²/`1330935378`; RMAP-083 conserva el suelo rough de wetlands y deja 256²/`1330935379` exacto en landscape/clear. La siguiente causa es RMAP-081: la ruta/terminus de río diverge en 256²/`1330935380`; RMAP-082 conserva las ramas urbanas de `1330935379` y `1330935381` con entrada exacta. La evidencia detallada y el resto de avances se mantienen únicamente en `random-map-issues.md`, para no duplicar métricas. RMAP-004 sigue abierto mientras haya divergencias en otros tamaños/fases; RMAP-018 conserva la matriz de ríos grande/multiclima y RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034 la generalización de pueblos. |
...
rough ya preparado al plantar árboles de wetlands. Las cuatro seeds 64²
