...
- Waypoints viales: el suelo vanilla ya respeta `m5` (eje), `m3` (Roadside),
  ...
  como children. Los dos postes del layout vanilla y los layouts `TileSeq`
  estáticos de `NewGRF` ya se dibujan con suelo propio, cajas parent y
  children relativos; quedan layouts con registros/paletas dinámicos y
  sprites base.
