...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005–017, RMAP-019–023, RMAP-025–026, RMAP-028–029, RMAP-031, RMAP-033, RMAP-035–055, RMAP-057–058, RMAP-060, RMAP-063–064 y RMAP-066–079 cerrados; RMAP-018/RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034/RMAP-056/RMAP-059/RMAP-061/RMAP-062/RMAP-065 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². `landscape`, `clear` y ahora `towns` son exactos (0 teselas/0 bloques 4×4) para las seeds 64² `1330935378`, `1330935379`, `1330935380` y `1330935381`; RMAP-054 alineó costa/`HasTileWaterGround`, RMAP-055 fijó la frontera RNG de industrias, RMAP-057 ordenó el catálogo/roster, RMAP-058 conserva las cuatro palabras RNG, RMAP-060 propaga el layout sorteado, RMAP-063 conserva la cola del constructor vanilla y RMAP-064 reproduce `MakeIndustry` byte a byte en la cohorte de carbón. RMAP-066–067 cierran los solapes Industry/House del auto-clear. RMAP-068 reproduce la plantación/Fences de Farm y deja OilWells e IronOreMine en los sitios nativos de ambas seeds; RMAP-069 cierra la asignación del ID cero y la pertenencia de huellas; RMAP-070 cierra las probabilidades y el sorteo terrestre; RMAP-071 cierra los gates de agua/puente/vehículo y el rollback de plataforma; RMAP-072 separa las pasadas tierra/agua sin inventar RNG; RMAP-073/RMAP-074 corrigen la frontera de lagos y RMAP-076 completa el tramo ejecutable de YAPF, terminus, ensanchamiento y terraform compartido para 64²/128² temperate por defecto; RMAP-075 reinicializa MAP4 al crear industrias, RMAP-077 corrige la métrica costera Manhattan, RMAP-078 normaliza el comando vial en pendiente y RMAP-079 materializa los puentes viales municipales planos sobre río/canal. RMAP-059 conserva la secuencia force-one, RMAP-061 su plataforma, RMAP-062 sus conflictos y RMAP-065 el diagnóstico residual. RMAP-056 conserva la admisión acuática/`IT_OIL_RIG` pendiente. La descripción y evidencia detallada se mantiene únicamente en `random-map-issues.md`, para no duplicar métricas. RMAP-004 sigue abierto mientras haya divergencias en otros tamaños/fases; RMAP-018 conserva la matriz de ríos grande/multiclima y RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034 la generalización de pueblos. |
...
Última etapa RMAP-064/069/070/071/072/073/074/075/076/079: la plantación de Farm replica ahora el orden de RNG,
...
municipal plano sobre río/canal. Las cuatro seeds 64²
(`1330935378`–`1330935381`) quedan exactas en paisaje, clear, towns e industrias.
RMAP-056 conserva
