...
Base funcional publicada en `origin/main`: **`eb6bd78d`** (`sav: preserve opaque
custom industry cargo rows`). Este handoff documental incluye la entrega directa
...
datos al reexportarse sin el GRF. La próxima tarea sigue siendo cargos custom
...
Última validación de `eb6bd78d`: `cargo fmt --all -- --check`, clippy estricto
