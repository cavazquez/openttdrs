...
paridad ni cierre de #326: `ROTSG_*` custom, Action5 tram `DEPOT_NO_TRACK`,
catenaria y waypoints viales siguen fuera, y el detalle cuantitativo canónico
queda en `PARIDAD.md`.
