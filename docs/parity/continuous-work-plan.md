...
El subtramo de badges de vehículos ya traduce GlobalVar `0x18`, conserva las
listas `ReadBadgeList` por `EngineDef` y expone `0x64`/`0x7A`; queda separado el
`0x65` dependiente de badges de rail/road y el resto de variables secundarias.
