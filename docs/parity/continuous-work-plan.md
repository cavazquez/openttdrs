...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005–017, RMAP-019–023, RMAP-025–026, RMAP-028–029, RMAP-031, RMAP-033, RMAP-035–054 cerrados; RMAP-018/RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². `landscape`, `clear` y ahora `towns` son exactos (0 teselas/0 bloques 4×4) para las seeds 64² `1330935378` y `1330935379`; RMAP-054 alineó costa/`HasTileWaterGround` y el clear lateral de casas. La descripción y evidencia detallada se mantiene únicamente en `random-map-issues.md`, para no duplicar métricas. RMAP-004 sigue abierto mientras haya divergencias en otros tamaños/fases; RMAP-018 conserva el trazado completo de ríos y RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034 la generalización de pueblos. |
...
Última etapa RMAP-054 (cerrada): el walker de pueblos ya distingue costa de
agua plena mediante `HasTileWaterGround`, por lo que puede despejar y recorrer
una costa como hace OpenTTD. `ClearMakeHouseTile` también vuelve a limpiar el
estado non-flooding de las ocho teselas vecinas antes de escribir cada parte de
la casa. Con ello, la matriz `towns` de las seeds 64² `1330935378` y
`1330935379` es exacta (0 teselas/0 bloques 4×4) y la secuencia completa de
tres pueblos de la primera termina en `[11204508,1784072412]`. Es un cierre
acotado: RMAP-004/RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034 permanecen
abiertos para tamaños, terrenos, secuencias, callbacks y huellas no cubiertos.
