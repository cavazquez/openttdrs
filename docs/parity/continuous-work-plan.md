...
2. Contratos de datos: pagos **#586**, transferencia **#587**, ORDL **#588** y
   filtro de cargo GS **#598** están implementados y esperan CI remota vigente
   antes del cierre; ownership **#591** sigue el orden indicado.
