...
| 7 | Idiomas y settings (#331) | Abierto | Catálogo de idiomas, locale, settings y textos guardados se cargan y se comparan con OpenTTD sin colisiones ECS ni regresiones de UI. El corte #448 localiza las cuatro frases estáticas de recesión económica en ticker/popup y deja explícitamente sin traducir los textos parametrizados; siguen pendientes las plantillas de NewsItem y el resto de catálogos `.lng`. |
