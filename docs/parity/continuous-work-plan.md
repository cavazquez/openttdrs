...
| 7 | Idiomas y settings (#331) | Abierto | Catálogo de idiomas, locale, settings y textos guardados se cargan y se comparan con OpenTTD sin colisiones ECS ni regresiones de UI. Los cortes #448, #449 y #450 localizan las frases estáticas de recesión, los headlines de desastres y el body fijo de cierre de industria en ticker/popup, dejando explícitamente sin traducir coordenadas, nombres y textos parametrizados; siguen pendientes las plantillas de NewsItem y el resto de catálogos `.lng`. |
