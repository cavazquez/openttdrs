...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005–017, RMAP-019–023, RMAP-025–026, RMAP-028–029, RMAP-031, RMAP-033, RMAP-035–055, RMAP-057–058, RMAP-060, RMAP-063–064, RMAP-066–081 y RMAP-083–085 cerrados; RMAP-018/RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034/RMAP-056/RMAP-059/RMAP-061/RMAP-062/RMAP-065/RMAP-082 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². RMAP-081 completa `landscape` 256² para `1330935378`–`1330935381` al excluir `MP_VOID` de `RiverMakeWider`; la entrada de `clear` queda exacta, RMAP-084 cubre la rampa de llegada inclinada de un puente municipal y RMAP-085 reproduce el coste/clear atómico de su terraformación. RMAP-082 conserva una rama urbana pendiente (`1330935381`). La evidencia detallada y el resto de avances se mantienen únicamente en `random-map-issues.md`, para no duplicar métricas. RMAP-004 sigue abierto mientras haya divergencias en otros tamaños/fases; RMAP-018 conserva la matriz de ríos grande/multiclima y RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034 la generalización de pueblos. |
...
ríos sobre el borde libre `MP_VOID`. Las cuatro seeds 64²
