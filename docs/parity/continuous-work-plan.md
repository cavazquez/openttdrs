...
Última etapa RMAP-067: el auto-clear de layout ahora rechaza una casa, tanto
para vanilla como para `IndustrySpecDef` NewGRF. Esto alinea SteelMill y Farm
en las dos seeds 64², pero OilWells diverge tras los campos de Farm; RMAP-068
acota esa frontera RNG. RMAP-064 conserva los bytes nativos y RMAP-056 la
selección tierra/agua. No se declara paridad de industrias ni se cierran
