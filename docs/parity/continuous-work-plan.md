...
`0xA7`/`0xA9`/`0xAC` y `0xB0`/`0xB3`, y `INDY` importa/exporta los campos
nativos correspondientes. #329 y el bloque SAV siguen abiertos por PSA,
`last_accepted`, historiales anidados, cargos custom y callbacks restantes.
