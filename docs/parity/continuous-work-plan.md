...
Base funcional publicada en `origin/main`: **`704de575`** (`style: format
industry exports`). Este handoff documental se publica inmediatamente después
de la etapa funcional de `65682a42`; es el punto de reanudación y los cambios
de código y formato están en el mismo árbol.
...
Última validación de `704de575`: `cargo fmt --all -- --check`, clippy estricto
de core, **1.967** tests de core y **1.064** de cliente (2 ignorados); la matriz
