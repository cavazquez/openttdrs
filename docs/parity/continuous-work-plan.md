...
- Aeropuertos NewGRF: los layouts `Airports` conservan el `gfx` global de cada
  ...
  quedan los triggers FTA (carga/descarga/aterrizaje), foundations, badges y
  rotaciones runtime del compositor, por lo que #329 continúa abierto.
