...
Base funcional publicada en `origin/main`: **`916247a2`** (`newgrf: connect
industry randomisation triggers`). Este handoff documental se publica inmediatamente
...
Última validación de `916247a2`: `cargo fmt --all -- --check`, clippy estricto
