...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005/RMAP-006/RMAP-007/RMAP-008/RMAP-009/RMAP-010/RMAP-011/RMAP-012/RMAP-013/RMAP-014/RMAP-015/RMAP-016/RMAP-017/RMAP-019/RMAP-020/RMAP-021/RMAP-022/RMAP-023/RMAP-025/RMAP-026/RMAP-028 cerrados; RMAP-018/RMAP-024/RMAP-027 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². El oráculo RMAP-013 ya exporta `world-raw` directo en cada frontera. RMAP-015/016/017 reprodujeron el tile loop y la topología de costa; RMAP-020 separó el pozo largo de 64² y RMAP-022 alineó sus intentos `RandomTile` con el stream global. Por eso `landscape` y `clear` ya son exactos en ambas seeds 64² (0 teselas y 0/256 bloques 4×4), incluido el `m3` de RMAP-019. RMAP-025 iguala el total sugerido, RMAP-026 el primer selector y RMAP-028 el sorteo de tamaño/ciudad; la métrica de `towns` queda en 170/27 bloques para `1330935378` y 310/45 para `1330935379`, no como mejora uniforme mientras falte `GrowTown`. RMAP-027 debe portar `DoCreateTown` antes de afirmar una secuencia completa. RMAP-018 sigue abierto para el creador completo de ríos en mapas donde el original sí los construye. RMAP-004 no se cierra mientras queden bytes distintos. El pre/post RMAP-007 deja `GenerateTrees` vanilla exacto en los cuatro climas. |
