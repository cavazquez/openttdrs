...
| 2 | RMAP-004: generador procedural | Abierto P1 (TGP, RMAP-005/RMAP-007/RMAP-008/RMAP-009/RMAP-010 cerrados; RMAP-011 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects/trees con matriz 64²→512². La comparación por etapas confirma TGP crudo, ajuste de nivel, costas, suavizados y seno idénticos en 65×65 puntos para la semilla de referencia; RMAP-005 fija fields/desierto/costa y `GetTileZ` de árboles. El oráculo pre/post versionado de RMAP-007 retoma el RNG de `DATE`: temperate 64² y ártico (cuatro semillas 64² y una 128²) son exactos después de persistir la línea de nieve y el multiplicador en RMAP-010. Sigue RMAP-011 (zonas/tipos/pase de rainforest tropical) y luego la primera divergencia de las fases anteriores. Cerrar sólo cuando el mismo seed no tenga divergencias no explicadas en clear, población, objetos, árboles y bytes de tesela. |
