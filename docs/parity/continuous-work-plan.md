...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005–017, RMAP-019–023, RMAP-025–026, RMAP-028–029, RMAP-031, RMAP-033, RMAP-035–055, RMAP-057–058, RMAP-060, RMAP-063–064 y RMAP-066–080 cerrados; RMAP-018/RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034/RMAP-056/RMAP-059/RMAP-061/RMAP-062/RMAP-065/RMAP-081/RMAP-082 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². RMAP-080 amplía la cohorte urbana exacta a 256²/`1330935378`: `LevelTownLand` propaga los vértices y el tipo `MAP6` queda sólo en rampas. La siguiente causa es RMAP-081: landscape diverge ya en 256²/`1330935379`; RMAP-082 conserva la rama urbana de 256²/`1330935381` con landscape/clear exactos. La evidencia detallada y el resto de avances se mantienen únicamente en `random-map-issues.md`, para no duplicar métricas. RMAP-004 sigue abierto mientras haya divergencias en otros tamaños/fases; RMAP-018 conserva la matriz de ríos grande/multiclima y RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034 la generalización de pueblos. |
...
Última etapa RMAP-064/069/070/071/072/073/074/075/076/079/080: la plantación de Farm replica ahora el orden de RNG,
...
entre vértices y conserva `MAP6` de tipo fuera del vano. Las cuatro seeds 64²
