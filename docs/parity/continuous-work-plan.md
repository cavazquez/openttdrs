...
Última etapa RMAP-066: la comprobación de layout no permite limpiar en automático
una tesela `Industry`, tanto para vanilla como para `IndustrySpecDef` NewGRF.
Las dos seeds 64² recuperan la geometría completa de la huella Forest, pero la
matriz de industrias sigue divergente; RMAP-065 conserva el diagnóstico de
SteelMill, RMAP-064 los bytes nativos y RMAP-056 la selección tierra/agua. No
se declara paridad de industrias ni se cierran
