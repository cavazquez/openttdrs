...
#517 Tree/`OnTick_Trees` en la visita o frontera actual del stream global. La
medición diaria, las recurrencias y el
...
bloques actuales de `TileLoop_Industry`/`TileLoop_Town` y #517
`TileLoop_Trees`/`OnTick_Trees`; #512 mantiene separado el RNG NewGRF
posterior. Los
