...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005/RMAP-006/RMAP-007/RMAP-008/RMAP-009/RMAP-010/RMAP-011/RMAP-012/RMAP-013 cerrados; RMAP-014 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². El oráculo RMAP-013 ya exporta `world-raw` directo en cada frontera y ubica la primera divergencia coarse en `clear` para dos seeds 64²; el pre/post RMAP-007 deja `GenerateTrees` vanilla exacto en los cuatro climas. No confundir esos cierres aislados con la entrada que produce el generador propio. Sigue RMAP-014: exportar el lado Rust antes de `GenerateClearTile` y separar paisaje de clear antes de corregir bytes. Cerrar sólo cuando el mismo seed no tenga divergencias no explicadas en clear, población, objetos y bytes de tesela. |
