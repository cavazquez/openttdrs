...
Última etapa RMAP-063 (cerrada): después de aceptar una industria vanilla, el
generador conserva la cola RNG de producción smooth, color, teselas y triggers
de construcción. RMAP-061 ya hace que la primera mina siga la aceptación
nativa, pero RMAP-062 aún debe aplicar conflictos/town association y RMAP-064
debe escribir los bytes nativos. RMAP-056 sigue abierto para tierra/agua y
