...
| 5 | NewGRF runtime (#329) | Abierto | Vehículos, estaciones, objetos e industrias ya tienen rutas runtime parciales; vehículos además resuelven grupos Action2 real por etapa cargada/cargando y hasta ocho capas de sprite-stack, y casas reevalúan Action2 por tesela (etapa/hash, edad, terreno, frame, posición y random/triggers). Los roadtypes conservan grupos Action3 específicos por selector, la caché los separa por `ROTSG_*` y el compositor de puentes ya los invoca desde la rampa sur/vano para superficie y overlay. Siguen pendientes grupos de catenaria y mitad frontal del draw-proc, callbacks/layouts completos de casas, vehículos, estaciones, aeropuertos, objetos, industrias y cargos, además de persistencia NGRF/OBJS. |
...
- Composición #326: el bloque publicado de puentes enlaza cabezas de rampa,
  ...
  trasero combinado. Sigue pendiente la mitad frontal de
