...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005–017, RMAP-019–023, RMAP-025–026, RMAP-028–029, RMAP-031, RMAP-033, RMAP-035–055, RMAP-057–058, RMAP-060, RMAP-063 y RMAP-066–069 cerrados; RMAP-018/RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034/RMAP-056/RMAP-059/RMAP-061/RMAP-062/RMAP-064/RMAP-065 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². `landscape`, `clear` y ahora `towns` son exactos (0 teselas/0 bloques 4×4) para las seeds 64² `1330935378` y `1330935379`; RMAP-054 alineó costa/`HasTileWaterGround`, RMAP-055 fijó la frontera RNG de industrias, RMAP-057 ordenó el catálogo/roster, RMAP-058 conserva las cuatro palabras RNG, RMAP-060 propaga el layout sorteado, RMAP-063 conserva la cola del constructor vanilla y RMAP-066–067 cierran los solapes Industry/House del auto-clear. RMAP-068 reproduce la plantación/Fences de Farm y deja OilWells e IronOreMine en los sitios nativos de ambas seeds; RMAP-069 cierra la asignación del ID cero y la pertenencia de huellas; RMAP-059 conserva la secuencia force-one, RMAP-061 su plataforma, RMAP-062 sus conflictos, RMAP-064 sus bytes y RMAP-065 el diagnóstico residual. RMAP-056 conserva la selección tierra/agua. La descripción y evidencia detallada se mantiene únicamente en `random-map-issues.md`, para no duplicar métricas. RMAP-004 sigue abierto mientras haya divergencias en otros tamaños/fases; RMAP-018 conserva el trazado completo de ríos y RMAP-024/RMAP-027/RMAP-030/RMAP-032/RMAP-034 la generalización de pueblos. |
...
Última etapa RMAP-069: la plantación de Farm replica ahora el orden de RNG,
la geometría y las cercas de OpenTTD, y el primer `IndustryID(0)` permanece
vinculado a toda su huella durante la obra. Así OilWells e IronOreMine vuelven
a los sitios nativos en las dos seeds 64²; RMAP-064 conserva los bytes nativos
y RMAP-056 la selección tierra/agua. No se declara paridad de industrias ni se
