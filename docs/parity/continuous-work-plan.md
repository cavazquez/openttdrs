...
| 2 | RMAP-004: generador procedural | Abierto P1 (RMAP-005/RMAP-006/RMAP-007/RMAP-008/RMAP-009/RMAP-010/RMAP-011/RMAP-012/RMAP-013/RMAP-014/RMAP-015/RMAP-016/RMAP-017 cerrados; RMAP-018/RMAP-019 en curso) | Reducir la primera divergencia de TGP/RNG/`FixSlopes`/clear/towns/industries/objects con matriz 64²→512². El oráculo RMAP-013 ya exporta `world-raw` directo en cada frontera; RMAP-014 añadió el lado Rust preclear y reveló que la primera divergencia está ya en `landscape`. RMAP-015 reprodujo las 256 pasadas `RunTileLoop` post-río con tick fijo y redujo 64²/seed `1330935378` de 1177/117 bloques a 356/73. RMAP-016/017 implementaron el conversor por pendiente y la guarda `FLOOD_DRYUP`, dejando 21/7 bloques para la primera semilla y 40/11 para la segunda. RMAP-018 toma el creador de ríos simplificado y RMAP-019 el único bit `m3`; RMAP-004 no se cierra mientras queden bytes distintos. El pre/post RMAP-007 deja `GenerateTrees` vanilla exacto en los cuatro climas. |
