...
Última etapa RMAP-045 (cerrada): la ventana 30–44 de `GrowTown` mantiene la
misma secuencia de RNG después de la casa de curva; la frontera queda
`[2310750700,2493436935]`. Es progreso del walker aislado, no una mejora de
