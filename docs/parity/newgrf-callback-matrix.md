...
14. Vehicles CB36 — resolver signed/unsigned, aplicar acortamiento `0x21`/`0x23`, consultar velocidad por clase y capacidad al crear/refitar/articular; quedan capacidad dinámica durante la partida, potencia, esfuerzo tractor, costes y el resto de propiedades económicas/de rendimiento.
