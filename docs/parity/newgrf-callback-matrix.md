...
`ReadBadgeList` nativa (índices WORD), saltando previamente las propiedades
bridgeable `0x13`/`0x14` para no perder la lista cuando aparecen antes. La
...
`BaseStation` siguen pendientes en #329.
