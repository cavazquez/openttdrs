...
- Resto de CBs houses / airports / industries / objects (excepto CB157), cargo (excepto CB39/CB145). Stations aún requieren scopes completos y sonidos; RoadStops aún carece de scopes vecinos, resolución de tipos viales externos, sonidos y de recuperar desde `.sav` el mapeo nativo de spec por tesela custom.
