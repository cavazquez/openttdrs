...
| Industries (`0A`) | `0x28` `CBID_INDUSTRY_LOCATION` | **soportado** (#266) | Call site: `place_industry_spec_def_sandbox`; respeta el bit `Location`, carga Action3→Action2 y sólo permite `FAILED`/`0x400`. Faltan scopes/parametrización completos y strings de error GRF |
