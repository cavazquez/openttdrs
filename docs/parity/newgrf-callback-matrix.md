...
Actualizada: **2026-09-03** (commit `704de575`, shape-check, foundations,
autoslope, color y rechazo temporal de cargas de industrias; triggers y PSA
parent ya publicados).
...
| Industries | `0x22`, `0x37`–`0x3B`, `0x14A`+, … | **almacenado** | `IndustrySpecDef.callback_mask` |
