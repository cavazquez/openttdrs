...
14. Vehicles CB36 — resolver signed/unsigned, aplicar acortamiento `0x21`/`0x23`, consultar velocidad por clase y capacidad al crear/refitar/articular, y resolver potencia/peso/TE para los recálculos ferroviario y vial con catálogo; quedan capacidad dinámica durante la partida, callbacks de adelantamiento y APIs legacy sin catálogo, costes y el resto de propiedades económicas/de rendimiento.
