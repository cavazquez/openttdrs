...
14. Vehicles CB36 — resolver signed/unsigned, aplicar acortamiento `0x21`/`0x23`, consultar velocidad por clase y capacidad al crear/refitar/articular, y resolver potencia/peso/TE para el recálculo ferroviario; quedan capacidad dinámica durante la partida, integración vial con catálogo, costes y el resto de propiedades económicas/de rendimiento.
