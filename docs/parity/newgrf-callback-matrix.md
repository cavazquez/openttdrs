...
18. Stations CB149 — parcial por tesela al construir, desde Action0 `0x0B` y Action3→Action2 cargados; query y execute rechazan antes de mutar, aplican la inversión de bit 10 para GRF <8 y conservan el texto de resultados `0..0x3FF`/`0x40F` para el feedback. Siguen pendientes scopes/vecinos y parámetros dinámicos del text stack.
