...
| Vehicles | `0x16`, `0x19`, `0x1D`, `0x23`, `0x2D`, `0x34`–`0x36`, … | **OOS** | Evaluador Action2 listo; sin call sites |
...
| Vehicle/station random Action2 (`0x80`/`0x83`/`0x84`) en resolve de sprites | **Parcial** (eval con `random_bits`; reseed gameplay vía API #266; vehículos ya consumen `Callback32` y conservan triggers pendientes) |
