...
- Resto de CBs houses / airports / industries / objects (excepto CB157), cargo (excepto CB39/CB145). Stations aún requieren scopes completos y sonidos; RoadStops ya resuelve `60`–`65`/`69` junto con `66`/`67`/`68`/`6A`/`6B` al renderizar, pero CB140–142 y randomización siguen sin los flags mensuales/históricos completos de `69`, town/company, resolución de tipos viales externos, sonidos y recuperación desde `.sav` del mapeo nativo de spec por tesela custom.
