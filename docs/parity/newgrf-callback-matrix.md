...
14. Vehicles CB36 — resolver signed/unsigned, aplicar el acortamiento `0x21`/`0x23` y consultar la velocidad por clase en movimiento/rating; quedan capacidad, potencia, esfuerzo tractor, costes y el resto de propiedades económicas/de rendimiento.
