...
Actualizada: **2026-09-03** (commit `6e3ad37a`, shape-check, foundations,
autoslope, color, rechazo temporal, cargos dinámicos y efectos especiales de
industrias; triggers, PSA parent y `CargoTypesUnlimited` ya publicados).
...
24. Industries CB3B — efectos especiales periódicos de campos/árboles; call site y fallback implementados, `PlantOnBuild`/goldens aún pendientes.
