...
bordes de 1280×720. Así la decoración no reduce el framebuffer a 1280×653;
no selecciona ni cambia de display, no recorta la imagen, no usa un display
virtual y no altera el límite de 60 s.
