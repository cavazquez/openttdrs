...
| Oráculo PBS externo | Fixture `train_pbs_15_3.sav` + 40 ticks OpenTTD — [PBS_EXTERNAL_ORACLE.md](../PBS_EXTERNAL_ORACLE.md); cinemática + reservas alineadas (`rail_pixel` + `DoUpdateSpeed` + 2× loco) |
