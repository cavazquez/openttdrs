...
| Pendiente → velocidad | `train_movement.rs::affect_speed_by_z_change` + `vehicle.rs::apply_train_z_speed_change` (Δ`GetTileZ` al cruzar tesela) | `train_cmd.cpp:3140-3152` (`AffectSpeedByZChange`), `:3601-3603` | 2 · probado (MVP tile-Z) | `affect_speed_by_z_change_matches_accel_slowdown`, `train_loses_speed_when_climbing_tile_z`, `train_gains_speed_when_descending_tile_z` | Medio: sin ΔZ subpíxel de `UpdateInclination` |
