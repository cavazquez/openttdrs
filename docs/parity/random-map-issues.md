...
| **RMAP-006** | Diferencial completo de la fase de árboles. | **Abierto (P1)** | Separar consumo RNG, grupos, pases por altura, nieve/tropical y la interacción con clear/pueblos/industrias. Tras RMAP-005, el caso 64²/seed `1330935378` conserva 1.814 teselas distintas (200/256 bloques 4×4); OpenTTD tiene 352 árboles —24 de costa— y el candidato 453 —17 de costa—. Es evidencia de fase incompleta, no motivo para cerrar RMAP-004. |
